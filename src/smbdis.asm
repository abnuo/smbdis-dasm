...
VRAM_AddrTable_Low:
      dc.b <VRAM_Buffer1, <WaterPaletteData, <GroundPaletteData
      dc.b <UndergroundPaletteData, <CastlePaletteData, <VRAM_Buffer1_Offset
      dc.b <VRAM_Buffer2, <VRAM_Buffer2, <BowserPaletteData
      dc.b <DaySnowPaletteData, <NightSnowPaletteData, <MushroomPaletteData
      dc.b <MarioThanksMessage, <LuigiThanksMessage, <MushroomRetainerSaved
      dc.b <PrincessSaved1, <PrincessSaved2, <WorldSelectMessage1
      dc.b <WorldSelectMessage2
...
VRAM_Buffer_Offset:
      dc.b <VRAM_Buffer1_Offset, <VRAM_Buffer2_Offset
...
MoveAllSpritesOffscreen:
              ...
              dc.b $2c                 ;BIT instruction opcode
...
TitleScreenMode:
      ...
      dc.w InitializeGame
      dc.w ScreenRoutines
      dc.w PrimaryGameSetup
      dc.w GameMenuRoutine

;-------------------------------------------------------------------------------------

WSelectBufferTemplate:
      dc.b $04, $20, $73, $01, $00, $00
...
DemoActionData:
      dc.b $01, $80, $02, $81, $41, $80, $01
      dc.b $42, $c2, $02, $80, $41, $c1, $41, $c1
      dc.b $01, $c1, $01, $02, $80, $00

DemoTimingData:
      dc.b $9b, $10, $18, $05, $2c, $20, $24
      dc.b $15, $5a, $10, $20, $28, $30, $20, $10
      dc.b $80, $20, $30, $30, $01, $ff, $00
...
VictoryModeSubroutines:
      ...
      dc.w BridgeCollapse
      dc.w SetupVictoryMode
      dc.w PlayerVictoryWalk
      dc.w PrintVictoryMessages
      dc.w PlayerEndWorld
...
ScreenRoutines:
      ...
      dc.w InitScreen
      dc.w SetupIntermediate
      dc.w WriteTopStatusLine
      dc.w WriteBottomStatusLine
      dc.w DisplayTimeUp
      dc.w ResetSpritesAndScreenTimer
      dc.w DisplayIntermediate
      dc.w ResetSpritesAndScreenTimer
      dc.w AreaParserTaskControl
      dc.w GetAreaPalette
      dc.w GetBackgroundColor
      dc.w GetAlternatePalette1
      dc.w DrawTitleScreen
      dc.w ClearBuffersDrawIcon
      dc.w WriteTopScore
...
BackgroundColors:
      dc.b $22, $22, $0f, $0f ;used by area type if bg color ctrl not set
      dc.b $0f, $22, $0f, $0f ;used by background color control if set

PlayerColors:
      dc.b $22, $16, $27, $18 ;mario's colors
      dc.b $22, $30, $27, $19 ;luigi's colors
      dc.b $22, $37, $27, $16 ;fiery (used by both)
...
GameText:
TopStatusBarLine:
  dc.b $20, $43, $05, $16, $0a, $1b, $12, $18 ; "MARIO"
  dc.b $20, $52, $0b, $20, $18, $1b, $15, $0d ; "WORLD  TIME"
  dc.b $24, $24, $1d, $12, $16, $0e
  dc.b $20, $68, $05, $00, $24, $24, $2e, $29 ; score trailing digit and coin display
  dc.b $23, $c0, $7f, $aa ; attribute table data, clears name table 0 to palette 2
  dc.b $23, $c2, $01, $ea ; attribute table data, used for coin icon in status bar
  dc.b $ff ; end of data block

WorldLivesDisplay:
  dc.b $21, $cd, $07, $24, $24 ; cross with spaces used on
  dc.b $29, $24, $24, $24, $24 ; lives display
  dc.b $21, $4b, $09, $20, $18 ; "WORLD  - " used on lives display
  dc.b $1b, $15, $0d, $24, $24, $28, $24
  dc.b $22, $0c, $47, $24 ; possibly used to clear time up
  dc.b $23, $dc, $01, $ba ; attribute table data for crown if more than 9 lives
  dc.b $ff

TwoPlayerTimeUp:
  dc.b $21, $cd, $05, $16, $0a, $1b, $12, $18 ; "MARIO"
OnePlayerTimeUp:
  dc.b $22, $0c, $07, $1d, $12, $16, $0e, $24, $1e, $19 ; "TIME UP"
  dc.b $ff

TwoPlayerGameOver:
  dc.b $21, $cd, $05, $16, $0a, $1b, $12, $18 ; "MARIO"
OnePlayerGameOver:
  dc.b $22, $0b, $09, $10, $0a, $16, $0e, $24 ; "GAME OVER"
  dc.b $18, $1f, $0e, $1b
  dc.b $ff

WarpZoneWelcome:
  dc.b $25, $84, $15, $20, $0e, $15, $0c, $18, $16 ; "WELCOME TO WARP ZONE!"
  dc.b $0e, $24, $1d, $18, $24, $20, $0a, $1b, $19
  dc.b $24, $23, $18, $17, $0e, $2b
  dc.b $26, $25, $01, $24         ; placeholder for left pipe
  dc.b $26, $2d, $01, $24         ; placeholder for middle pipe
  dc.b $26, $35, $01, $24         ; placeholder for right pipe
  dc.b $27, $d9, $46, $aa         ; attribute data
  dc.b $27, $e1, $45, $aa
  dc.b $ff

LuigiName:
  dc.b $15, $1e, $12, $10, $12    ; "LUIGI", no address or length

WarpZoneNumbers:
  dc.b $04, $03, $02, $00         ; warp zone numbers, note spaces on middle
  dc.b $24, $05, $24, $00         ; zone, partly responsible for
  dc.b $08, $07, $06, $00         ; the minus world

GameTextOffsets:
  dc.b TopStatusBarLine-GameText, TopStatusBarLine-GameText
  dc.b WorldLivesDisplay-GameText, WorldLivesDisplay-GameText
  dc.b TwoPlayerTimeUp-GameText, OnePlayerTimeUp-GameText
  dc.b TwoPlayerGameOver-GameText, OnePlayerGameOver-GameText
  dc.b WarpZoneWelcome-GameText, WarpZoneWelcome-GameText
...
ColorRotatePalette:
       dc.b $27, $27, $27, $17, $07, $17

BlankPalette:
       dc.b $3f, $0c, $04, $ff, $ff, $ff, $ff, $00
...
MetatileGraphics_Low:
  dc.b <Palette0_MTiles, <Palette1_MTiles, <Palette2_MTiles, <Palette3_MTiles

MetatileGraphics_High:
  dc.b >Palette0_MTiles, >Palette1_MTiles, >Palette2_MTiles, >Palette3_MTiles

Palette0_MTiles:
  dc.b $24, $24, $24, $24 ;blank
  dc.b $27, $27, $27, $27 ;black metatile
  dc.b $24, $24, $24, $35 ;bush left
  dc.b $36, $25, $37, $25 ;bush middle
  dc.b $24, $38, $24, $24 ;bush right
  dc.b $24, $30, $30, $26 ;mountain left
  dc.b $26, $26, $34, $26 ;mountain left bottom/middle center
  dc.b $24, $31, $24, $32 ;mountain middle top
  dc.b $33, $26, $24, $33 ;mountain right
  dc.b $34, $26, $26, $26 ;mountain right bottom
  dc.b $26, $26, $26, $26 ;mountain middle bottom
  dc.b $24, $c0, $24, $c0 ;bridge guardrail
  dc.b $24, $7f, $7f, $24 ;chain
  dc.b $b8, $ba, $b9, $bb ;tall tree top, top half
  dc.b $b8, $bc, $b9, $bd ;short tree top
  dc.b $ba, $bc, $bb, $bd ;tall tree top, bottom half
  dc.b $60, $64, $61, $65 ;warp pipe end left, points up
  dc.b $62, $66, $63, $67 ;warp pipe end right, points up
  dc.b $60, $64, $61, $65 ;decoration pipe end left, points up
  dc.b $62, $66, $63, $67 ;decoration pipe end right, points up
  dc.b $68, $68, $69, $69 ;pipe shaft left
  dc.b $26, $26, $6a, $6a ;pipe shaft right
  dc.b $4b, $4c, $4d, $4e ;tree ledge left edge
  dc.b $4d, $4f, $4d, $4f ;tree ledge middle
  dc.b $4d, $4e, $50, $51 ;tree ledge right edge
  dc.b $6b, $70, $2c, $2d ;mushroom left edge
  dc.b $6c, $71, $6d, $72 ;mushroom middle
  dc.b $6e, $73, $6f, $74 ;mushroom right edge
  dc.b $86, $8a, $87, $8b ;sideways pipe end top
  dc.b $88, $8c, $88, $8c ;sideways pipe shaft top
  dc.b $89, $8d, $69, $69 ;sideways pipe joint top
  dc.b $8e, $91, $8f, $92 ;sideways pipe end bottom
  dc.b $26, $93, $26, $93 ;sideways pipe shaft bottom
  dc.b $90, $94, $69, $69 ;sideways pipe joint bottom
  dc.b $a4, $e9, $ea, $eb ;seaplant
  dc.b $24, $24, $24, $24 ;blank, used on bricks or blocks that are hit
  dc.b $24, $2f, $24, $3d ;flagpole ball
  dc.b $a2, $a2, $a3, $a3 ;flagpole shaft
  dc.b $24, $24, $24, $24 ;blank, used in conjunction with vines

Palette1_MTiles:
  dc.b $a2, $a2, $a3, $a3 ;vertical rope
  dc.b $99, $24, $99, $24 ;horizontal rope
  dc.b $24, $a2, $3e, $3f ;left pulley
  dc.b $5b, $5c, $24, $a3 ;right pulley
  dc.b $24, $24, $24, $24 ;blank used for balance rope
  dc.b $9d, $47, $9e, $47 ;castle top
  dc.b $47, $47, $27, $27 ;castle window left
  dc.b $47, $47, $47, $47 ;castle brick wall
  dc.b $27, $27, $47, $47 ;castle window right
  dc.b $a9, $47, $aa, $47 ;castle top w/ brick
  dc.b $9b, $27, $9c, $27 ;entrance top
  dc.b $27, $27, $27, $27 ;entrance bottom
  dc.b $52, $52, $52, $52 ;green ledge stump
  dc.b $80, $a0, $81, $a1 ;fence
  dc.b $be, $be, $bf, $bf ;tree trunk
  dc.b $75, $ba, $76, $bb ;mushroom stump top
  dc.b $ba, $ba, $bb, $bb ;mushroom stump bottom
  dc.b $45, $47, $45, $47 ;breakable brick w/ line 
  dc.b $47, $47, $47, $47 ;breakable brick 
  dc.b $45, $47, $45, $47 ;breakable brick (not used)
  dc.b $b4, $b6, $b5, $b7 ;cracked rock terrain
  dc.b $45, $47, $45, $47 ;brick with line (power-up)
  dc.b $45, $47, $45, $47 ;brick with line (vine)
  dc.b $45, $47, $45, $47 ;brick with line (star)
  dc.b $45, $47, $45, $47 ;brick with line (coins)
  dc.b $45, $47, $45, $47 ;brick with line (1-up)
  dc.b $47, $47, $47, $47 ;brick (power-up)
  dc.b $47, $47, $47, $47 ;brick (vine)
  dc.b $47, $47, $47, $47 ;brick (star)
  dc.b $47, $47, $47, $47 ;brick (coins)
  dc.b $47, $47, $47, $47 ;brick (1-up)
  dc.b $24, $24, $24, $24 ;hidden block (1 coin)
  dc.b $24, $24, $24, $24 ;hidden block (1-up)
  dc.b $ab, $ac, $ad, $ae ;solid block (3-d block)
  dc.b $5d, $5e, $5d, $5e ;solid block (white wall)
  dc.b $c1, $24, $c1, $24 ;bridge
  dc.b $c6, $c8, $c7, $c9 ;bullet bill cannon barrel
  dc.b $ca, $cc, $cb, $cd ;bullet bill cannon top
  dc.b $2a, $2a, $40, $40 ;bullet bill cannon bottom
  dc.b $24, $24, $24, $24 ;blank used for jumpspring
  dc.b $24, $47, $24, $47 ;half brick used for jumpspring
  dc.b $82, $83, $84, $85 ;solid block (water level, green rock)
  dc.b $24, $47, $24, $47 ;half brick (???)
  dc.b $86, $8a, $87, $8b ;water pipe top
  dc.b $8e, $91, $8f, $92 ;water pipe bottom
  dc.b $24, $2f, $24, $3d ;flag ball (residual object)

Palette2_MTiles:
  dc.b $24, $24, $24, $35 ;cloud left
  dc.b $36, $25, $37, $25 ;cloud middle
  dc.b $24, $38, $24, $24 ;cloud right
  dc.b $24, $24, $39, $24 ;cloud bottom left
  dc.b $3a, $24, $3b, $24 ;cloud bottom middle
  dc.b $3c, $24, $24, $24 ;cloud bottom right
  dc.b $41, $26, $41, $26 ;water/lava top
  dc.b $26, $26, $26, $26 ;water/lava
  dc.b $b0, $b1, $b2, $b3 ;cloud level terrain
  dc.b $77, $79, $77, $79 ;bowser's bridge
      
Palette3_MTiles:
  dc.b $53, $55, $54, $56 ;question block (coin)
  dc.b $53, $55, $54, $56 ;question block (power-up)
  dc.b $a5, $a7, $a6, $a8 ;coin
  dc.b $c2, $c4, $c3, $c5 ;underwater coin
  dc.b $57, $59, $58, $5a ;empty block
  dc.b $7b, $7d, $7c, $7e ;axe
...
;"THANK YOU MARIO!"
  dc.b $25, $48, $10
  dc.b $1d, $11, $0a, $17, $14, $24
  dc.b $22, $18, $1e, $24
  dc.b $16, $0a, $1b, $12, $18, $2b
  dc.b $00
...
;"THANK YOU LUIGI!"
  ...
  dc.b $1d, $11, $0a, $17, $14, $24
  dc.b $22, $18, $1e, $24
  dc.b $15, $1e, $12, $10, $12, $2b
  dc.b $00

MushroomRetainerSaved:
;"BUT OUR PRINCESS IS IN"
  dc.b $25, $c5, $16
  dc.b $0b, $1e, $1d, $24, $18, $1e, $1b, $24
  dc.b $19, $1b, $12, $17, $0c, $0e, $1c, $1c, $24
  dc.b $12, $1c, $24, $12, $17
;"ANOTHER CASTLE!"
  dc.b $26, $05, $0f
  dc.b $0a, $17, $18, $1d, $11, $0e, $1b, $24
  dc.b $0c, $0a, $1c, $1d, $15, $0e, $2b, $00

PrincessSaved1:
;"YOUR QUEST IS OVER."
  dc.b $25, $a7, $13
  dc.b $22, $18, $1e, $1b, $24
  dc.b $1a, $1e, $0e, $1c, $1d, $24
  dc.b $12, $1c, $24, $18, $1f, $0e, $1b, $af
  dc.b $00
...
;"WE PRESENT YOU A NEW QUEST."
  dc.b $25, $e3, $1b
  dc.b $20, $0e, $24
  dc.b $19, $1b, $0e, $1c, $0e, $17, $1d, $24
  dc.b $22, $18, $1e, $24, $0a, $24, $17, $0e, $20, $24
  dc.b $1a, $1e, $0e, $1c, $1d, $af
  dc.b $00
...
;"PUSH BUTTON B"
  dc.b $26, $4a, $0d
  dc.b $19, $1e, $1c, $11, $24
  dc.b $0b, $1e, $1d, $1d, $18, $17, $24, $0b
  dc.b $00

WorldSelectMessage2:
;"TO SELECT A WORLD"
  dc.b $26, $88, $11
  dc.b $1d, $18, $24, $1c, $0e, $15, $0e, $0c, $1d, $24
  dc.b $0a, $24, $20, $18, $1b, $15, $0d
  dc.b $00
...
StatusBarData:
      dc.b $f0, $06 ; top score display on title screen
      dc.b $62, $06 ; player score
      dc.b $62, $06
      dc.b $6d, $02 ; coin tally
      dc.b $6d, $02
      dc.b $7a, $03 ; game timer

StatusBarOffset:
      dc.b $06, $0c, $12, $18, $1e, $24
...
DefaultSprOffsets:
      dc.b $04, $30, $48, $60, $78, $90, $a8, $c0
      dc.b $d8, $e8, $24, $f8, $fc, $28, $2c
...
MusicSelectData:
      dc.b WaterMusic, GroundMusic, UndergroundMusic, CastleMusic
      dc.b CloudMusic, PipeIntroMusic
...
GameTimerData:
      dc.b $20 ;dummy byte, used as part of bg priority data
      dc.b $04, $03, $02
...
AreaParserTasks:
      ...
      dc.w IncrementColumnPos
      dc.w RenderAreaGraphics
      dc.w RenderAreaGraphics
      dc.w AreaParserCore
      dc.w IncrementColumnPos
      dc.w RenderAreaGraphics
...
BackSceneryData:
   dc.b $93, $00, $00, $11, $12, $12, $13, $00 ;clouds
   dc.b $00, $51, $52, $53, $00, $00, $00, $00
   dc.b $00, $00, $01, $02, $02, $03, $00, $00
   dc.b $00, $00, $00, $00, $91, $92, $93, $00
   dc.b $00, $00, $00, $51, $52, $53, $41, $42
   dc.b $43, $00, $00, $00, $00, $00, $91, $92

   dc.b $97, $87, $88, $89, $99, $00, $00, $00 ;mountains and bushes
   dc.b $11, $12, $13, $a4, $a5, $a5, $a5, $a6
   dc.b $97, $98, $99, $01, $02, $03, $00, $a4
   dc.b $a5, $a6, $00, $11, $12, $12, $12, $13
   dc.b $00, $00, $00, $00, $01, $02, $02, $03
   dc.b $00, $a4, $a5, $a5, $a6, $00, $00, $00

   dc.b $11, $12, $12, $13, $00, $00, $00, $00 ;trees and fences
   dc.b $00, $00, $00, $9c, $00, $8b, $aa, $aa
   dc.b $aa, $aa, $11, $12, $13, $8b, $00, $9c
   dc.b $9c, $00, $00, $01, $02, $03, $11, $12
   dc.b $12, $13, $00, $00, $00, $00, $aa, $aa
   dc.b $9c, $aa, $00, $8b, $00, $01, $02, $03

BackSceneryMetatiles:
   dc.b $80, $83, $00 ;cloud left
   dc.b $81, $84, $00 ;cloud middle
   dc.b $82, $85, $00 ;cloud right
   dc.b $02, $00, $00 ;bush left
   dc.b $03, $00, $00 ;bush middle
   dc.b $04, $00, $00 ;bush right
   dc.b $00, $05, $06 ;mountain left
   dc.b $07, $06, $0a ;mountain middle
   dc.b $00, $08, $09 ;mountain right
   dc.b $4d, $00, $00 ;fence
   dc.b $0d, $0f, $4e ;tall tree
   dc.b $0e, $4e, $4e ;short tree

FSceneDataOffsets:
      dc.b $00, $0d, $1a

ForeSceneryData:
   dc.b $86, $87, $87, $87, $87, $87, $87   ;in water
   dc.b $87, $87, $87, $87, $69, $69

   dc.b $00, $00, $00, $00, $00, $45, $47   ;wall
   dc.b $47, $47, $47, $47, $00, $00

   dc.b $00, $00, $00, $00, $00, $00, $00   ;over water
   dc.b $00, $00, $00, $00, $86, $87

TerrainMetatiles:
      dc.b $69, $54, $52, $62

TerrainRenderBits:
      dc.b %00000000, %00000000 ;no ceiling or floor
      dc.b %00000000, %00011000 ;no ceiling, floor 2
      dc.b %00000001, %00011000 ;ceiling 1, floor 2
      dc.b %00000111, %00011000 ;ceiling 3, floor 2
      dc.b %00001111, %00011000 ;ceiling 4, floor 2
      dc.b %11111111, %00011000 ;ceiling 8, floor 2
      dc.b %00000001, %00011111 ;ceiling 1, floor 5
      dc.b %00000111, %00011111 ;ceiling 3, floor 5
      dc.b %00001111, %00011111 ;ceiling 4, floor 5
      dc.b %10000001, %00011111 ;ceiling 1, floor 6
      dc.b %00000001, %00000000 ;ceiling 1, no floor
      dc.b %10001111, %00011111 ;ceiling 4, floor 6
      dc.b %11110001, %00011111 ;ceiling 1, floor 9
      dc.b %11111001, %00011000 ;ceiling 1, middle 5, floor 2
      dc.b %11110001, %00011000 ;ceiling 1, middle 4, floor 2
      dc.b %11111111, %00011111 ;completely solid top to bottom
...
;large objects (rows $00-$0b or 00-11, d6-d4 set)
      dc.w VerticalPipe         ;used by warp pipes
      dc.w AreaStyleObject
      dc.w RowOfBricks
      dc.w RowOfSolidBlocks
      dc.w RowOfCoins
      dc.w ColumnOfBricks
      dc.w ColumnOfSolidBlocks
      dc.w VerticalPipe         ;used by decoration pipes

;objects for special row $0c or 12
      dc.w Hole_Empty
      dc.w PulleyRopeObject
      dc.w Bridge_High
      dc.w Bridge_Middle
      dc.w Bridge_Low
      dc.w Hole_Water
      dc.w QuestionBlockRow_High
      dc.w QuestionBlockRow_Low

;objects for special row $0f or 15
      dc.w EndlessRope
      dc.w BalancePlatRope
      dc.w CastleObject
      dc.w StaircaseObject
      dc.w ExitPipe
      dc.w FlagBalls_Residual

;small objects (rows $00-$0b or 00-11, d6-d4 all clear)
      dc.w QuestionBlock     ;power-up
      dc.w QuestionBlock     ;coin
      dc.w QuestionBlock     ;hidden, coin
      dc.w Hidden1UpBlock    ;hidden, 1-up
      dc.w BrickWithItem     ;brick, power-up
      dc.w BrickWithItem     ;brick, vine
      dc.w BrickWithItem     ;brick, star
      dc.w BrickWithCoins    ;brick, coins
      dc.w BrickWithItem     ;brick, 1-up
      dc.w WaterPipe
      dc.w EmptyBlock
      dc.w Jumpspring
...
;objects for special row $0d or 13 (d6 set)
      ...
      dc.w AxeObj
      dc.w ChainObj
      dc.w CastleBridgeObj
      dc.w ScrollLockObject_Warp
      dc.w ScrollLockObject
      dc.w ScrollLockObject
      dc.w AreaFrenzy            ;flying cheep-cheeps 
      dc.w AreaFrenzy            ;bullet bills or swimming cheep-cheeps
      dc.w AreaFrenzy            ;stop frenzy
      dc.w LoopCmdE

;object for special row $0e or 14
      dc.w AlterAreaAttributes
...
FrenzyIDData:
      dc.b FlyCheepCheepFrenzy, BBill_CCheep_Frenzy, Stop_Frenzy
...
AreaStyleObject:
      ...
      jsr JumpEngine 
      dc.w TreeLedge        ;also used for cloud type levels
      dc.w MushroomLedge
      dc.w BulletBillCannon
...
SidePipeShaftData:
      dc.b $15, $14  ;used to control whether or not vertical pipe shaft
      dc.b $00, $00  ;is drawn, and if so, controls the metatile number
SidePipeTopPart:
      dc.b $15, $1e  ;top part of sideways part of pipe
      dc.b $1d, $1c
SidePipeBottomPart: 
      dc.b $15, $21  ;bottom part of sideways part of pipe
      dc.b $20, $1f
...
VerticalPipeData:
      dc.b $11, $10 ;used by pipes that lead somewhere
      dc.b $15, $14
      dc.b $13, $12 ;used by decoration pipes
      dc.b $15, $14
...
BrickMetatiles:
      dc.b $22, $51, $52, $52
      dc.b $88 ;used only by row of bricks object
...
StaircaseHeightData:
      dc.b $07, $07, $06, $05, $04, $03, $02, $01, $00

StaircaseRowData:
      dc.b $03, $03, $04, $05, $06, $07, $08, $09, $0a
...
BlockBufferAddr:
      dc.b <Block_Buffer_1, <Block_Buffer_2
      dc.b >Block_Buffer_1, >Block_Buffer_2
...
AreaDataOfsLoopback:
      dc.b $12, $36, $0e, $0e, $0e, $32, $32, $32, $0a, $26, $40
...
WorldAddrOffsets:
      dc.b World1Areas-AreaAddrOffsets, World2Areas-AreaAddrOffsets
      dc.b World3Areas-AreaAddrOffsets, World4Areas-AreaAddrOffsets
      dc.b World5Areas-AreaAddrOffsets, World6Areas-AreaAddrOffsets
      dc.b World7Areas-AreaAddrOffsets, World8Areas-AreaAddrOffsets

AreaAddrOffsets:
World1Areas: dc.b $25, $29, $c0, $26, $60
World2Areas: dc.b $28, $29, $01, $27, $62
World3Areas: dc.b $24, $35, $20, $63
World4Areas: dc.b $22, $29, $41, $2c, $61
World5Areas: dc.b $2a, $31, $26, $62
World6Areas: dc.b $2e, $23, $2d, $60
World7Areas: dc.b $33, $29, $01, $27, $64
World8Areas: dc.b $30, $32, $21, $65
...
EnemyDataAddrLow:
      dc.b <E_CastleArea1, <E_CastleArea2, <E_CastleArea3, <E_CastleArea4, <E_CastleArea5, <E_CastleArea6
      dc.b <E_GroundArea1, <E_GroundArea2, <E_GroundArea3, <E_GroundArea4, <E_GroundArea5, <E_GroundArea6
      dc.b <E_GroundArea7, <E_GroundArea8, <E_GroundArea9, <E_GroundArea10, <E_GroundArea11, <E_GroundArea12
      dc.b <E_GroundArea13, <E_GroundArea14, <E_GroundArea15, <E_GroundArea16, <E_GroundArea17, <E_GroundArea18
      dc.b <E_GroundArea19, <E_GroundArea20, <E_GroundArea21, <E_GroundArea22, <E_UndergroundArea1
      dc.b <E_UndergroundArea2, <E_UndergroundArea3, <E_WaterArea1, <E_WaterArea2, <E_WaterArea3
...
AreaDataAddrLow:
      dc.b <L_WaterArea1, <L_WaterArea2, <L_WaterArea3, <L_GroundArea1, <L_GroundArea2, <L_GroundArea3
      dc.b <L_GroundArea4, <L_GroundArea5, <L_GroundArea6, <L_GroundArea7, <L_GroundArea8, <L_GroundArea9
      dc.b <L_GroundArea10, <L_GroundArea11, <L_GroundArea12, <L_GroundArea13, <L_GroundArea14, <L_GroundArea15
      dc.b <L_GroundArea16, <L_GroundArea17, <L_GroundArea18, <L_GroundArea19, <L_GroundArea20, <L_GroundArea21
      dc.b <L_GroundArea22, <L_UndergroundArea1, <L_UndergroundArea2, <L_UndergroundArea3, <L_CastleArea1
      dc.b <L_CastleArea2, <L_CastleArea3, <L_CastleArea4, <L_CastleArea5, <L_CastleArea6
...
;level 1-4/6-4
E_CastleArea1:
      dc.b $76, $dd, $bb, $4c, $ea, $1d, $1b, $cc, $56, $5d
      dc.b $16, $9d, $c6, $1d, $36, $9d, $c9, $1d, $04, $db
      dc.b $49, $1d, $84, $1b, $c9, $5d, $88, $95, $0f, $08
      dc.b $30, $4c, $78, $2d, $a6, $28, $90, $b5
      dc.b $ff

;level 4-4
E_CastleArea2:
      dc.b $0f, $03, $56, $1b, $c9, $1b, $0f, $07, $36, $1b
      dc.b $aa, $1b, $48, $95, $0f, $0a, $2a, $1b, $5b, $0c
      dc.b $78, $2d, $90, $b5
      dc.b $ff

;level 2-4/5-4
E_CastleArea3:
      dc.b $0b, $8c, $4b, $4c, $77, $5f, $eb, $0c, $bd, $db
      dc.b $19, $9d, $75, $1d, $7d, $5b, $d9, $1d, $3d, $dd
      dc.b $99, $1d, $26, $9d, $5a, $2b, $8a, $2c, $ca, $1b
      dc.b $20, $95, $7b, $5c, $db, $4c, $1b, $cc, $3b, $cc
      dc.b $78, $2d, $a6, $28, $90, $b5
      dc.b $ff

;level 3-4
E_CastleArea4:
      dc.b $0b, $8c, $3b, $1d, $8b, $1d, $ab, $0c, $db, $1d
      dc.b $0f, $03, $65, $1d, $6b, $1b, $05, $9d, $0b, $1b
      dc.b $05, $9b, $0b, $1d, $8b, $0c, $1b, $8c, $70, $15
      dc.b $7b, $0c, $db, $0c, $0f, $08, $78, $2d, $a6, $28
      dc.b $90, $b5
      dc.b $ff

;level 7-4
E_CastleArea5:
      dc.b $27, $a9, $4b, $0c, $68, $29, $0f, $06, $77, $1b
      dc.b $0f, $0b, $60, $15, $4b, $8c, $78, $2d, $90, $b5
      dc.b $ff

;level 8-4
E_CastleArea6:
      dc.b $0f, $03, $8e, $65, $e1, $bb, $38, $6d, $a8, $3e, $e5, $e7
      dc.b $0f, $08, $0b, $02, $2b, $02, $5e, $65, $e1, $bb, $0e
      dc.b $db, $0e, $bb, $8e, $db, $0e, $fe, $65, $ec, $0f, $0d
      dc.b $4e, $65, $e1, $0f, $0e, $4e, $02, $e0, $0f, $10, $fe, $e5, $e1
      dc.b $1b, $85, $7b, $0c, $5b, $95, $78, $2d, $90, $b5
      dc.b $ff

;level 3-3
E_GroundArea1:
      dc.b $a5, $86, $e4, $28, $18, $a8, $45, $83, $69, $03
      dc.b $c6, $29, $9b, $83, $16, $a4, $88, $24, $e9, $28
      dc.b $05, $a8, $7b, $28, $24, $8f, $c8, $03, $e8, $03
      dc.b $46, $a8, $85, $24, $c8, $24
      dc.b $ff

;level 8-3
E_GroundArea2:
      dc.b $eb, $8e, $0f, $03, $fb, $05, $17, $85, $db, $8e
      dc.b $0f, $07, $57, $05, $7b, $05, $9b, $80, $2b, $85
      dc.b $fb, $05, $0f, $0b, $1b, $05, $9b, $05
      dc.b $ff

;level 4-1
E_GroundArea3:
      dc.b $2e, $c2, $66, $e2, $11, $0f, $07, $02, $11, $0f, $0c
      dc.b $12, $11
      dc.b $ff

;level 6-2
E_GroundArea4:
      dc.b $0e, $c2, $a8, $ab, $00, $bb, $8e, $6b, $82, $de, $00, $a0
      dc.b $33, $86, $43, $06, $3e, $b4, $a0, $cb, $02, $0f, $07
      dc.b $7e, $42, $a6, $83, $02, $0f, $0a, $3b, $02, $cb, $37
      dc.b $0f, $0c, $e3, $0e
      dc.b $ff

;level 3-1
E_GroundArea5:
      dc.b $9b, $8e, $ca, $0e, $ee, $42, $44, $5b, $86, $80, $b8
      dc.b $1b, $80, $50, $ba, $10, $b7, $5b, $00, $17, $85
      dc.b $4b, $05, $fe, $34, $40, $b7, $86, $c6, $06, $5b, $80
      dc.b $83, $00, $d0, $38, $5b, $8e, $8a, $0e, $a6, $00
      dc.b $bb, $0e, $c5, $80, $f3, $00
      dc.b $ff

;level 1-1
E_GroundArea6:
      dc.b $1e, $c2, $00, $6b, $06, $8b, $86, $63, $b7, $0f, $05
      dc.b $03, $06, $23, $06, $4b, $b7, $bb, $00, $5b, $b7
      dc.b $fb, $37, $3b, $b7, $0f, $0b, $1b, $37
      dc.b $ff

;level 1-3/5-3
E_GroundArea7:
      dc.b $2b, $d7, $e3, $03, $c2, $86, $e2, $06, $76, $a5
      dc.b $a3, $8f, $03, $86, $2b, $57, $68, $28, $e9, $28
      dc.b $e5, $83, $24, $8f, $36, $a8, $5b, $03
      dc.b $ff

;level 2-3/7-3
E_GroundArea8:
      dc.b $0f, $02, $78, $40, $48, $ce, $f8, $c3, $f8, $c3
      dc.b $0f, $07, $7b, $43, $c6, $d0, $0f, $8a, $c8, $50
      dc.b $ff

;level 2-1
E_GroundArea9:
      dc.b $85, $86, $0b, $80, $1b, $00, $db, $37, $77, $80
      dc.b $eb, $37, $fe, $2b, $20, $2b, $80, $7b, $38, $ab, $b8
      dc.b $77, $86, $fe, $42, $20, $49, $86, $8b, $06, $9b, $80
      dc.b $7b, $8e, $5b, $b7, $9b, $0e, $bb, $0e, $9b, $80
...
;level 5-1
E_GroundArea11:
      dc.b $0b, $80, $60, $38, $10, $b8, $c0, $3b, $db, $8e
      dc.b $40, $b8, $f0, $38, $7b, $8e, $a0, $b8, $c0, $b8
      dc.b $fb, $00, $a0, $b8, $30, $bb, $ee, $42, $88, $0f, $0b
      dc.b $2b, $0e, $67, $0e
      dc.b $ff

;cloud level used in levels 2-1 and 5-2
E_GroundArea12:
      dc.b $0a, $aa, $0e, $28, $2a, $0e, $31, $88
      dc.b $ff

;level 4-3
E_GroundArea13:
      dc.b $c7, $83, $d7, $03, $42, $8f, $7a, $03, $05, $a4
      dc.b $78, $24, $a6, $25, $e4, $25, $4b, $83, $e3, $03
      dc.b $05, $a4, $89, $24, $b5, $24, $09, $a4, $65, $24
      dc.b $c9, $24, $0f, $08, $85, $25
      dc.b $ff

;level 6-3
E_GroundArea14:
      dc.b $cd, $a5, $b5, $a8, $07, $a8, $76, $28, $cc, $25
      dc.b $65, $a4, $a9, $24, $e5, $24, $19, $a4, $0f, $07
      dc.b $95, $28, $e6, $24, $19, $a4, $d7, $29, $16, $a9
      dc.b $58, $29, $97, $29
      dc.b $ff

;level 6-1
E_GroundArea15:
      dc.b $0f, $02, $02, $11, $0f, $07, $02, $11
      dc.b $ff
...
;level 8-1
E_GroundArea17:
      dc.b $2b, $82, $ab, $38, $de, $42, $e2, $1b, $b8, $eb
      dc.b $3b, $db, $80, $8b, $b8, $1b, $82, $fb, $b8, $7b
      dc.b $80, $fb, $3c, $5b, $bc, $7b, $b8, $1b, $8e, $cb
      dc.b $0e, $1b, $8e, $0f, $0d, $2b, $3b, $bb, $b8, $eb, $82
      dc.b $4b, $b8, $bb, $38, $3b, $b7, $bb, $02, $0f, $13
      dc.b $1b, $00, $cb, $80, $6b, $bc
      dc.b $ff

;level 5-2
E_GroundArea18:
      dc.b $7b, $80, $ae, $00, $80, $8b, $8e, $e8, $05, $f9, $86 
      dc.b $17, $86, $16, $85, $4e, $2b, $80, $ab, $8e, $87, $85
      dc.b $c3, $05, $8b, $82, $9b, $02, $ab, $02, $bb, $86
      dc.b $cb, $06, $d3, $03, $3b, $8e, $6b, $0e, $a7, $8e
      dc.b $ff

;level 8-2
E_GroundArea19:
      dc.b $29, $8e, $52, $11, $83, $0e, $0f, $03, $9b, $0e
      dc.b $2b, $8e, $5b, $0e, $cb, $8e, $fb, $0e, $fb, $82
      dc.b $9b, $82, $bb, $02, $fe, $42, $e8, $bb, $8e, $0f, $0a
      dc.b $ab, $0e, $cb, $0e, $f9, $0e, $88, $86, $a6, $06
      dc.b $db, $02, $b6, $8e
      dc.b $ff

;level 7-1
E_GroundArea20:
      dc.b $ab, $ce, $de, $42, $c0, $cb, $ce, $5b, $8e, $1b, $ce
      dc.b $4b, $85, $67, $45, $0f, $07, $2b, $00, $7b, $85
      dc.b $97, $05, $0f, $0a, $92, $02
      dc.b $ff

;cloud level used in levels 3-1 and 6-2
E_GroundArea21:
      dc.b $0a, $aa, $0e, $24, $4a, $1e, $23, $aa
      dc.b $ff

;level 3-2
E_GroundArea22:
      dc.b $1b, $80, $bb, $38, $4b, $bc, $eb, $3b, $0f, $04
      dc.b $2b, $00, $ab, $38, $eb, $00, $cb, $8e, $fb, $80
      dc.b $ab, $b8, $6b, $80, $fb, $3c, $9b, $bb, $5b, $bc
      dc.b $fb, $00, $6b, $b8, $fb, $38
      dc.b $ff

;level 1-2
E_UndergroundArea1:
      dc.b $0b, $86, $1a, $06, $db, $06, $de, $c2, $02, $f0, $3b
      dc.b $bb, $80, $eb, $06, $0b, $86, $93, $06, $f0, $39
      dc.b $0f, $06, $60, $b8, $1b, $86, $a0, $b9, $b7, $27
      dc.b $bd, $27, $2b, $83, $a1, $26, $a9, $26, $ee, $25, $0b
      dc.b $27, $b4
      dc.b $ff

;level 4-2
E_UndergroundArea2:
      dc.b $0f, $02, $1e, $2f, $60, $e0, $3a, $a5, $a7, $db, $80
      dc.b $3b, $82, $8b, $02, $fe, $42, $68, $70, $bb, $25, $a7
      dc.b $2c, $27, $b2, $26, $b9, $26, $9b, $80, $a8, $82
      dc.b $b5, $27, $bc, $27, $b0, $bb, $3b, $82, $87, $34
      dc.b $ee, $25, $6b
      dc.b $ff

;underground bonus rooms area used in many levels
E_UndergroundArea3:
      dc.b $1e, $a5, $0a, $2e, $28, $27, $2e, $33, $c7, $0f, $03, $1e, $40, $07
      dc.b $2e, $30, $e7, $0f, $05, $1e, $24, $44, $0f, $07, $1e, $22, $6a
      dc.b $2e, $23, $ab, $0f, $09, $1e, $41, $68, $1e, $2a, $8a, $2e, $23, $a2
      dc.b $2e, $32, $ea
      dc.b $ff

;water area used in levels 5-2 and 6-2
E_WaterArea1:
      dc.b $3b, $87, $66, $27, $cc, $27, $ee, $31, $87, $ee, $23, $a7
      dc.b $3b, $87, $db, $07
      dc.b $ff

;level 2-2/7-2
E_WaterArea2:
      dc.b $0f, $01, $2e, $25, $2b, $2e, $25, $4b, $4e, $25, $cb, $6b, $07
      dc.b $97, $47, $e9, $87, $47, $c7, $7a, $07, $d6, $c7
      dc.b $78, $07, $38, $87, $ab, $47, $e3, $07, $9b, $87
      dc.b $0f, $09, $68, $47, $db, $c7, $3b, $c7
      dc.b $ff

;water area used in level 8-4
E_WaterArea3:
      dc.b $47, $9b, $cb, $07, $fa, $1d, $86, $9b, $3a, $87
      dc.b $56, $07, $88, $1b, $07, $9d, $2e, $65, $f0
      dc.b $ff
...
L_CastleArea1:
      dc.b $9b, $07
      dc.b $05, $32, $06, $33, $07, $34, $ce, $03, $dc, $51
      dc.b $ee, $07, $73, $e0, $74, $0a, $7e, $06, $9e, $0a
      dc.b $ce, $06, $e4, $00, $e8, $0a, $fe, $0a, $2e, $89
      dc.b $4e, $0b, $54, $0a, $14, $8a, $c4, $0a, $34, $8a
      dc.b $7e, $06, $c7, $0a, $01, $e0, $02, $0a, $47, $0a
      dc.b $81, $60, $82, $0a, $c7, $0a, $0e, $87, $7e, $02
      dc.b $a7, $02, $b3, $02, $d7, $02, $e3, $02, $07, $82
      dc.b $13, $02, $3e, $06, $7e, $02, $ae, $07, $fe, $0a
      dc.b $0d, $c4, $cd, $43, $ce, $09, $de, $0b, $dd, $42
      dc.b $fe, $02, $5d, $c7
      dc.b $fd
...
L_CastleArea2:
      dc.b $5b, $07
      dc.b $05, $32, $06, $33, $07, $34, $5e, $0a, $68, $64
      dc.b $98, $64, $a8, $64, $ce, $06, $fe, $02, $0d, $01
      dc.b $1e, $0e, $7e, $02, $94, $63, $b4, $63, $d4, $63
      dc.b $f4, $63, $14, $e3, $2e, $0e, $5e, $02, $64, $35
      dc.b $88, $72, $be, $0e, $0d, $04, $ae, $02, $ce, $08
      dc.b $cd, $4b, $fe, $02, $0d, $05, $68, $31, $7e, $0a
      dc.b $96, $31, $a9, $63, $a8, $33, $d5, $30, $ee, $02
      dc.b $e6, $62, $f4, $61, $04, $b1, $08, $3f, $44, $33
      dc.b $94, $63, $a4, $31, $e4, $31, $04, $bf, $08, $3f
      dc.b $04, $bf, $08, $3f, $cd, $4b, $03, $e4, $0e, $03
      dc.b $2e, $01, $7e, $06, $be, $02, $de, $06, $fe, $0a
      dc.b $0d, $c4, $cd, $43, $ce, $09, $de, $0b, $dd, $42
      dc.b $fe, $02, $5d, $c7
      dc.b $fd
...
L_CastleArea3:
      dc.b $9b, $07
      dc.b $05, $32, $06, $33, $07, $34, $fe, $00, $27, $b1
      dc.b $65, $32, $75, $0a, $71, $00, $b7, $31, $08, $e4
      dc.b $18, $64, $1e, $04, $57, $3b, $bb, $0a, $17, $8a
      dc.b $27, $3a, $73, $0a, $7b, $0a, $d7, $0a, $e7, $3a
      dc.b $3b, $8a, $97, $0a, $fe, $08, $24, $8a, $2e, $00
      dc.b $3e, $40, $38, $64, $6f, $00, $9f, $00, $be, $43
      dc.b $c8, $0a, $c9, $63, $ce, $07, $fe, $07, $2e, $81
      dc.b $66, $42, $6a, $42, $79, $0a, $be, $00, $c8, $64
      dc.b $f8, $64, $08, $e4, $2e, $07, $7e, $03, $9e, $07
      dc.b $be, $03, $de, $07, $fe, $0a, $03, $a5, $0d, $44
      dc.b $cd, $43, $ce, $09, $dd, $42, $de, $0b, $fe, $02
      dc.b $5d, $c7
      dc.b $fd
...
L_CastleArea4:
      dc.b $9b, $07
      dc.b $05, $32, $06, $33, $07, $34, $fe, $06, $0c, $81
      dc.b $39, $0a, $5c, $01, $89, $0a, $ac, $01, $d9, $0a
      dc.b $fc, $01, $2e, $83, $a7, $01, $b7, $00, $c7, $01
      dc.b $de, $0a, $fe, $02, $4e, $83, $5a, $32, $63, $0a
      dc.b $69, $0a, $7e, $02, $ee, $03, $fa, $32, $03, $8a
      dc.b $09, $0a, $1e, $02, $ee, $03, $fa, $32, $03, $8a
      dc.b $09, $0a, $14, $42, $1e, $02, $7e, $0a, $9e, $07
      dc.b $fe, $0a, $2e, $86, $5e, $0a, $8e, $06, $be, $0a
      dc.b $ee, $07, $3e, $83, $5e, $07, $fe, $0a, $0d, $c4
      dc.b $41, $52, $51, $52, $cd, $43, $ce, $09, $de, $0b
      dc.b $dd, $42, $fe, $02, $5d, $c7
      dc.b $fd

;level 7-4
L_CastleArea5:
      dc.b $5b, $07
      dc.b $05, $32, $06, $33, $07, $34, $fe, $0a, $ae, $86
      dc.b $be, $07, $fe, $02, $0d, $02, $27, $32, $46, $61
      dc.b $55, $62, $5e, $0e, $1e, $82, $68, $3c, $74, $3a
      dc.b $7d, $4b, $5e, $8e, $7d, $4b, $7e, $82, $84, $62
      dc.b $94, $61, $a4, $31, $bd, $4b, $ce, $06, $fe, $02
      dc.b $0d, $06, $34, $31, $3e, $0a, $64, $32, $75, $0a
      dc.b $7b, $61, $a4, $33, $ae, $02, $de, $0e, $3e, $82
      dc.b $64, $32, $78, $32, $b4, $36, $c8, $36, $dd, $4b
      dc.b $44, $b2, $58, $32, $94, $63, $a4, $3e, $ba, $30
      dc.b $c9, $61, $ce, $06, $dd, $4b, $ce, $86, $dd, $4b
      dc.b $fe, $02, $2e, $86, $5e, $02, $7e, $06, $fe, $02
      dc.b $1e, $86, $3e, $02, $5e, $06, $7e, $02, $9e, $06
      dc.b $fe, $0a, $0d, $c4, $cd, $43, $ce, $09, $de, $0b
      dc.b $dd, $42, $fe, $02, $5d, $c7
      dc.b $fd
...
L_CastleArea6:
      dc.b $5b, $06
      dc.b $05, $32, $06, $33, $07, $34, $5e, $0a, $ae, $02
      dc.b $0d, $01, $39, $73, $0d, $03, $39, $7b, $4d, $4b
      dc.b $de, $06, $1e, $8a, $ae, $06, $c4, $33, $16, $fe
      dc.b $a5, $77, $fe, $02, $fe, $82, $0d, $07, $39, $73
      dc.b $a8, $74, $ed, $4b, $49, $fb, $e8, $74, $fe, $0a
      dc.b $2e, $82, $67, $02, $84, $7a, $87, $31, $0d, $0b
      dc.b $fe, $02, $0d, $0c, $39, $73, $5e, $06, $c6, $76
      dc.b $45, $ff, $be, $0a, $dd, $48, $fe, $06, $3d, $cb
      dc.b $46, $7e, $ad, $4a, $fe, $82, $39, $f3, $a9, $7b
      dc.b $4e, $8a, $9e, $07, $fe, $0a, $0d, $c4, $cd, $43
      dc.b $ce, $09, $de, $0b, $dd, $42, $fe, $02, $5d, $c7
      dc.b $fd

;level 3-3
L_GroundArea1:
      dc.b $94, $11
      dc.b $0f, $26, $fe, $10, $28, $94, $65, $15, $eb, $12
      dc.b $fa, $41, $4a, $96, $54, $40, $a4, $42, $b7, $13
      dc.b $e9, $19, $f5, $15, $11, $80, $47, $42, $71, $13
      dc.b $80, $41, $15, $92, $1b, $1f, $24, $40, $55, $12
      dc.b $64, $40, $95, $12, $a4, $40, $d2, $12, $e1, $40
      dc.b $13, $c0, $2c, $17, $2f, $12, $49, $13, $83, $40
      dc.b $9f, $14, $a3, $40, $17, $92, $83, $13, $92, $41
      dc.b $b9, $14, $c5, $12, $c8, $40, $d4, $40, $4b, $92
      dc.b $78, $1b, $9c, $94, $9f, $11, $df, $14, $fe, $11
      dc.b $7d, $c1, $9e, $42, $cf, $20
      dc.b $fd

;level 8-3
L_GroundArea2:
      dc.b $90, $b1
      dc.b $0f, $26, $29, $91, $7e, $42, $fe, $40, $28, $92
      dc.b $4e, $42, $2e, $c0, $57, $73, $c3, $25, $c7, $27
      dc.b $23, $84, $33, $20, $5c, $01, $77, $63, $88, $62
      dc.b $99, $61, $aa, $60, $bc, $01, $ee, $42, $4e, $c0
      dc.b $69, $11, $7e, $42, $de, $40, $f8, $62, $0e, $c2
      dc.b $ae, $40, $d7, $63, $e7, $63, $33, $a7, $37, $27
      dc.b $43, $04, $cc, $01, $e7, $73, $0c, $81, $3e, $42
      dc.b $0d, $0a, $5e, $40, $88, $72, $be, $42, $e7, $87
      dc.b $fe, $40, $39, $e1, $4e, $00, $69, $60, $87, $60
      dc.b $a5, $60, $c3, $31, $fe, $31, $6d, $c1, $be, $42
      dc.b $ef, $20
      dc.b $fd
...
L_GroundArea3:
      dc.b $52, $21
      dc.b $0f, $20, $6e, $40, $58, $f2, $93, $01, $97, $00
      dc.b $0c, $81, $97, $40, $a6, $41, $c7, $40, $0d, $04
      dc.b $03, $01, $07, $01, $23, $01, $27, $01, $ec, $03
      dc.b $ac, $f3, $c3, $03, $78, $e2, $94, $43, $47, $f3
      dc.b $74, $43, $47, $fb, $74, $43, $2c, $f1, $4c, $63
      dc.b $47, $00, $57, $21, $5c, $01, $7c, $72, $39, $f1
      dc.b $ec, $02, $4c, $81, $d8, $62, $ec, $01, $0d, $0d
      dc.b $0f, $38, $c7, $07, $ed, $4a, $1d, $c1, $5f, $26
      dc.b $fd

;level 6-2
L_GroundArea4:
      dc.b $54, $21
      dc.b $0f, $26, $a7, $22, $37, $fb, $73, $20, $83, $07
      dc.b $87, $02, $93, $20, $c7, $73, $04, $f1, $06, $31
      dc.b $39, $71, $59, $71, $e7, $73, $37, $a0, $47, $04
      dc.b $86, $7c, $e5, $71, $e7, $31, $33, $a4, $39, $71
      dc.b $a9, $71, $d3, $23, $08, $f2, $13, $05, $27, $02
      dc.b $49, $71, $75, $75, $e8, $72, $67, $f3, $99, $71
      dc.b $e7, $20, $f4, $72, $f7, $31, $17, $a0, $33, $20
      dc.b $39, $71, $73, $28, $bc, $05, $39, $f1, $79, $71
      dc.b $a6, $21, $c3, $06, $d3, $20, $dc, $00, $fc, $00
      dc.b $07, $a2, $13, $21, $5f, $32, $8c, $00, $98, $7a
      dc.b $c7, $63, $d9, $61, $03, $a2, $07, $22, $74, $72
      dc.b $77, $31, $e7, $73, $39, $f1, $58, $72, $77, $73
      dc.b $d8, $72, $7f, $b1, $97, $73, $b6, $64, $c5, $65
      dc.b $d4, $66, $e3, $67, $f3, $67, $8d, $c1, $cf, $26
      dc.b $fd

;level 3-1
L_GroundArea5:
      dc.b $52, $31
      dc.b $0f, $20, $6e, $66, $07, $81, $36, $01, $66, $00
      dc.b $a7, $22, $08, $f2, $67, $7b, $dc, $02, $98, $f2
      dc.b $d7, $20, $39, $f1, $9f, $33, $dc, $27, $dc, $57
      dc.b $23, $83, $57, $63, $6c, $51, $87, $63, $99, $61
      dc.b $a3, $06, $b3, $21, $77, $f3, $f3, $21, $f7, $2a
      dc.b $13, $81, $23, $22, $53, $00, $63, $22, $e9, $0b
      dc.b $0c, $83, $13, $21, $16, $22, $33, $05, $8f, $35
      dc.b $ec, $01, $63, $a0, $67, $20, $73, $01, $77, $01
      dc.b $83, $20, $87, $20, $b3, $20, $b7, $20, $c3, $01
      dc.b $c7, $00, $d3, $20, $d7, $20, $67, $a0, $77, $07
      dc.b $87, $22, $e8, $62, $f5, $65, $1c, $82, $7f, $38
      dc.b $8d, $c1, $cf, $26
      dc.b $fd
...
L_GroundArea6:
      dc.b $50, $21
      dc.b $07, $81, $47, $24, $57, $00, $63, $01, $77, $01
      dc.b $c9, $71, $68, $f2, $e7, $73, $97, $fb, $06, $83
      dc.b $5c, $01, $d7, $22, $e7, $00, $03, $a7, $6c, $02
      dc.b $b3, $22, $e3, $01, $e7, $07, $47, $a0, $57, $06
      dc.b $a7, $01, $d3, $00, $d7, $01, $07, $81, $67, $20
      dc.b $93, $22, $03, $a3, $1c, $61, $17, $21, $6f, $33
      dc.b $c7, $63, $d8, $62, $e9, $61, $fa, $60, $4f, $b3
      dc.b $87, $63, $9c, $01, $b7, $63, $c8, $62, $d9, $61
      dc.b $ea, $60, $39, $f1, $87, $21, $a7, $01, $b7, $20
      dc.b $39, $f1, $5f, $38, $6d, $c1, $af, $26
      dc.b $fd

;level 1-3/5-3
L_GroundArea7:
      dc.b $90, $11
      dc.b $0f, $26, $fe, $10, $2a, $93, $87, $17, $a3, $14
      dc.b $b2, $42, $0a, $92, $19, $40, $36, $14, $50, $41
      dc.b $82, $16, $2b, $93, $24, $41, $bb, $14, $b8, $00
      dc.b $c2, $43, $c3, $13, $1b, $94, $67, $12, $c4, $15
      dc.b $53, $c1, $d2, $41, $12, $c1, $29, $13, $85, $17
      dc.b $1b, $92, $1a, $42, $47, $13, $83, $41, $a7, $13
      dc.b $0e, $91, $a7, $63, $b7, $63, $c5, $65, $d5, $65
      dc.b $dd, $4a, $e3, $67, $f3, $67, $8d, $c1, $ae, $42
      dc.b $df, $20
      dc.b $fd
...
L_GroundArea8:
      dc.b $90, $11
      dc.b $0f, $26, $6e, $10, $8b, $17, $af, $32, $d8, $62
      dc.b $e8, $62, $fc, $3f, $ad, $c8, $f8, $64, $0c, $be
      dc.b $43, $43, $f8, $64, $0c, $bf, $73, $40, $84, $40
      dc.b $93, $40, $a4, $40, $b3, $40, $f8, $64, $48, $e4
      dc.b $5c, $39, $83, $40, $92, $41, $b3, $40, $f8, $64
      dc.b $48, $e4, $5c, $39, $f8, $64, $13, $c2, $37, $65
      dc.b $4c, $24, $63, $00, $97, $65, $c3, $42, $0b, $97
      dc.b $ac, $32, $f8, $64, $0c, $be, $53, $45, $9d, $48
      dc.b $f8, $64, $2a, $e2, $3c, $47, $56, $43, $ba, $62
      dc.b $f8, $64, $0c, $b7, $88, $64, $bc, $31, $d4, $45
      dc.b $fc, $31, $3c, $b1, $78, $64, $8c, $38, $0b, $9c
      dc.b $1a, $33, $18, $61, $28, $61, $39, $60, $5d, $4a
      dc.b $ee, $11, $0f, $b8, $1d, $c1, $3e, $42, $6f, $20
      dc.b $fd

;level 2-1
L_GroundArea9:
      dc.b $52, $31
      dc.b $0f, $20, $6e, $40, $f7, $20, $07, $84, $17, $20
      dc.b $4f, $34, $c3, $03, $c7, $02, $d3, $22, $27, $e3
      dc.b $39, $61, $e7, $73, $5c, $e4, $57, $00, $6c, $73
      dc.b $47, $a0, $53, $06, $63, $22, $a7, $73, $fc, $73
      dc.b $13, $a1, $33, $05, $43, $21, $5c, $72, $c3, $23
      dc.b $cc, $03, $77, $fb, $ac, $02, $39, $f1, $a7, $73
      dc.b $d3, $04, $e8, $72, $e3, $22, $26, $f4, $bc, $02
      dc.b $8c, $81, $a8, $62, $17, $87, $43, $24, $a7, $01
      dc.b $c3, $04, $08, $f2, $97, $21, $a3, $02, $c9, $0b
      dc.b $e1, $69, $f1, $69, $8d, $c1, $cf, $26
      dc.b $fd

;pipe intro area
L_GroundArea10:
      dc.b $38, $11
      dc.b $0f, $26, $ad, $40, $3d, $c7
      dc.b $fd

;level 5-1
L_GroundArea11:
      dc.b $95, $b1
      dc.b $0f, $26, $0d, $02, $c8, $72, $1c, $81, $38, $72
      dc.b $0d, $05, $97, $34, $98, $62, $a3, $20, $b3, $06
      dc.b $c3, $20, $cc, $03, $f9, $91, $2c, $81, $48, $62
      dc.b $0d, $09, $37, $63, $47, $03, $57, $21, $8c, $02
      dc.b $c5, $79, $c7, $31, $f9, $11, $39, $f1, $a9, $11
      dc.b $6f, $b4, $d3, $65, $e3, $65, $7d, $c1, $bf, $26
      dc.b $fd

;cloud level used in levels 2-1 and 5-2
L_GroundArea12:
      dc.b $00, $c1
      dc.b $4c, $00, $f4, $4f, $0d, $02, $02, $42, $43, $4f
      dc.b $52, $c2, $de, $00, $5a, $c2, $4d, $c7
      dc.b $fd

;level 4-3
L_GroundArea13:
      dc.b $90, $51
      dc.b $0f, $26, $ee, $10, $0b, $94, $33, $14, $42, $42
      dc.b $77, $16, $86, $44, $02, $92, $4a, $16, $69, $42
      dc.b $73, $14, $b0, $00, $c7, $12, $05, $c0, $1c, $17
      dc.b $1f, $11, $36, $12, $8f, $14, $91, $40, $1b, $94
      dc.b $35, $12, $34, $42, $60, $42, $61, $12, $87, $12
      dc.b $96, $40, $a3, $14, $1c, $98, $1f, $11, $47, $12
      dc.b $9f, $15, $cc, $15, $cf, $11, $05, $c0, $1f, $15
      dc.b $39, $12, $7c, $16, $7f, $11, $82, $40, $98, $12
      dc.b $df, $15, $16, $c4, $17, $14, $54, $12, $9b, $16
      dc.b $28, $94, $ce, $01, $3d, $c1, $5e, $42, $8f, $20
      dc.b $fd

;level 6-3
L_GroundArea14:
      dc.b $97, $11
      dc.b $0f, $26, $fe, $10, $2b, $92, $57, $12, $8b, $12
      dc.b $c0, $41, $f7, $13, $5b, $92, $69, $0b, $bb, $12
      dc.b $b2, $46, $19, $93, $71, $00, $17, $94, $7c, $14
      dc.b $7f, $11, $93, $41, $bf, $15, $fc, $13, $ff, $11
      dc.b $2f, $95, $50, $42, $51, $12, $58, $14, $a6, $12
      dc.b $db, $12, $1b, $93, $46, $43, $7b, $12, $8d, $49
      dc.b $b7, $14, $1b, $94, $49, $0b, $bb, $12, $fc, $13
      dc.b $ff, $12, $03, $c1, $2f, $15, $43, $12, $4b, $13
      dc.b $77, $13, $9d, $4a, $15, $c1, $a1, $41, $c3, $12
      dc.b $fe, $01, $7d, $c1, $9e, $42, $cf, $20
      dc.b $fd

;level 6-1
L_GroundArea15:
      dc.b $52, $21
      dc.b $0f, $20, $6e, $44, $0c, $f1, $4c, $01, $aa, $35
      dc.b $d9, $34, $ee, $20, $08, $b3, $37, $32, $43, $04
      dc.b $4e, $21, $53, $20, $7c, $01, $97, $21, $b7, $07
      dc.b $9c, $81, $e7, $42, $5f, $b3, $97, $63, $ac, $02
      dc.b $c5, $41, $49, $e0, $58, $61, $76, $64, $85, $65
      dc.b $94, $66, $a4, $22, $a6, $03, $c8, $22, $dc, $02
      dc.b $68, $f2, $96, $42, $13, $82, $17, $02, $af, $34
      dc.b $f6, $21, $fc, $06, $26, $80, $2a, $24, $36, $01
      dc.b $8c, $00, $ff, $35, $4e, $a0, $55, $21, $77, $20
      dc.b $87, $07, $89, $22, $ae, $21, $4c, $82, $9f, $34
      dc.b $ec, $01, $03, $e7, $13, $67, $8d, $4a, $ad, $41
      dc.b $0f, $a6
      dc.b $fd
...
L_GroundArea16:
      dc.b $10, $51
      dc.b $4c, $00, $c7, $12, $c6, $42, $03, $92, $02, $42
      dc.b $29, $12, $63, $12, $62, $42, $69, $14, $a5, $12
      dc.b $a4, $42, $e2, $14, $e1, $44, $f8, $16, $37, $c1
      dc.b $8f, $38, $02, $bb, $28, $7a, $68, $7a, $a8, $7a
      dc.b $e0, $6a, $f0, $6a, $6d, $c5
      dc.b $fd

;level 8-1
L_GroundArea17:
      dc.b $92, $31
      dc.b $0f, $20, $6e, $40, $0d, $02, $37, $73, $ec, $00
      dc.b $0c, $80, $3c, $00, $6c, $00, $9c, $00, $06, $c0
      dc.b $c7, $73, $06, $83, $28, $72, $96, $40, $e7, $73
      dc.b $26, $c0, $87, $7b, $d2, $41, $39, $f1, $c8, $f2
      dc.b $97, $e3, $a3, $23, $e7, $02, $e3, $07, $f3, $22
      dc.b $37, $e3, $9c, $00, $bc, $00, $ec, $00, $0c, $80
      dc.b $3c, $00, $86, $21, $a6, $06, $b6, $24, $5c, $80
      dc.b $7c, $00, $9c, $00, $29, $e1, $dc, $05, $f6, $41
      dc.b $dc, $80, $e8, $72, $0c, $81, $27, $73, $4c, $01
      dc.b $66, $74, $0d, $11, $3f, $35, $b6, $41, $2c, $82
      dc.b $36, $40, $7c, $02, $86, $40, $f9, $61, $39, $e1
      dc.b $ac, $04, $c6, $41, $0c, $83, $16, $41, $88, $f2
      dc.b $39, $f1, $7c, $00, $89, $61, $9c, $00, $a7, $63
      dc.b $bc, $00, $c5, $65, $dc, $00, $e3, $67, $f3, $67
      dc.b $8d, $c1, $cf, $26
      dc.b $fd
...
L_GroundArea18:
      dc.b $55, $b1
      dc.b $0f, $26, $cf, $33, $07, $b2, $15, $11, $52, $42
      dc.b $99, $0b, $ac, $02, $d3, $24, $d6, $42, $d7, $25
      dc.b $23, $84, $cf, $33, $07, $e3, $19, $61, $78, $7a
      dc.b $ef, $33, $2c, $81, $46, $64, $55, $65, $65, $65
      dc.b $ec, $74, $47, $82, $53, $05, $63, $21, $62, $41
      dc.b $96, $22, $9a, $41, $cc, $03, $b9, $91, $39, $f1
      dc.b $63, $26, $67, $27, $d3, $06, $fc, $01, $18, $e2
      dc.b $d9, $07, $e9, $04, $0c, $86, $37, $22, $93, $24
      dc.b $87, $84, $ac, $02, $c2, $41, $c3, $23, $d9, $71
      dc.b $fc, $01, $7f, $b1, $9c, $00, $a7, $63, $b6, $64
      dc.b $cc, $00, $d4, $66, $e3, $67, $f3, $67, $8d, $c1
      dc.b $cf, $26
      dc.b $fd
...
L_GroundArea19:
      dc.b $50, $b1
      dc.b $0f, $26, $fc, $00, $1f, $b3, $5c, $00, $65, $65
      dc.b $74, $66, $83, $67, $93, $67, $dc, $73, $4c, $80
      dc.b $b3, $20, $c9, $0b, $c3, $08, $d3, $2f, $dc, $00
      dc.b $2c, $80, $4c, $00, $8c, $00, $d3, $2e, $ed, $4a
      dc.b $fc, $00, $d7, $a1, $ec, $01, $4c, $80, $59, $11
      dc.b $d8, $11, $da, $10, $37, $a0, $47, $04, $99, $11
      dc.b $e7, $21, $3a, $90, $67, $20, $76, $10, $77, $60
      dc.b $87, $07, $d8, $12, $39, $f1, $ac, $00, $e9, $71
      dc.b $0c, $80, $2c, $00, $4c, $05, $c7, $7b, $39, $f1
      dc.b $ec, $00, $f9, $11, $0c, $82, $6f, $34, $f8, $11
      dc.b $fa, $10, $7f, $b2, $ac, $00, $b6, $64, $cc, $01
      dc.b $e3, $67, $f3, $67, $8d, $c1, $cf, $26
      dc.b $fd

;level 7-1
L_GroundArea20:
      dc.b $52, $b1
      dc.b $0f, $20, $6e, $45, $39, $91, $b3, $04, $c3, $21
      dc.b $c8, $11, $ca, $10, $49, $91, $7c, $73, $e8, $12
      dc.b $88, $91, $8a, $10, $e7, $21, $05, $91, $07, $30
      dc.b $17, $07, $27, $20, $49, $11, $9c, $01, $c8, $72
      dc.b $23, $a6, $27, $26, $d3, $03, $d8, $7a, $89, $91
      dc.b $d8, $72, $39, $f1, $a9, $11, $09, $f1, $63, $24
      dc.b $67, $24, $d8, $62, $28, $91, $2a, $10, $56, $21
      dc.b $70, $04, $79, $0b, $8c, $00, $94, $21, $9f, $35
      dc.b $2f, $b8, $3d, $c1, $7f, $26
      dc.b $fd

;cloud level used in levels 3-1 and 6-2
L_GroundArea21:
      dc.b $06, $c1
      dc.b $4c, $00, $f4, $4f, $0d, $02, $06, $20, $24, $4f
      dc.b $35, $a0, $36, $20, $53, $46, $d5, $20, $d6, $20
      dc.b $34, $a1, $73, $49, $74, $20, $94, $20, $b4, $20
      dc.b $d4, $20, $f4, $20, $2e, $80, $59, $42, $4d, $c7
      dc.b $fd

;level 3-2
L_GroundArea22:
      dc.b $96, $31
      dc.b $0f, $26, $0d, $03, $1a, $60, $77, $42, $c4, $00
      dc.b $c8, $62, $b9, $e1, $d3, $06, $d7, $07, $f9, $61
      dc.b $0c, $81, $4e, $b1, $8e, $b1, $bc, $01, $e4, $50
      dc.b $e9, $61, $0c, $81, $0d, $0a, $84, $43, $98, $72
      dc.b $0d, $0c, $0f, $38, $1d, $c1, $5f, $26
      dc.b $fd

;level 1-2
L_UndergroundArea1:
      dc.b $48, $0f
      dc.b $0e, $01, $5e, $02, $a7, $00, $bc, $73, $1a, $e0
      dc.b $39, $61, $58, $62, $77, $63, $97, $63, $b8, $62
      dc.b $d6, $07, $f8, $62, $19, $e1, $75, $52, $86, $40
      dc.b $87, $50, $95, $52, $93, $43, $a5, $21, $c5, $52
      dc.b $d6, $40, $d7, $20, $e5, $06, $e6, $51, $3e, $8d
      dc.b $5e, $03, $67, $52, $77, $52, $7e, $02, $9e, $03
      dc.b $a6, $43, $a7, $23, $de, $05, $fe, $02, $1e, $83
      dc.b $33, $54, $46, $40, $47, $21, $56, $04, $5e, $02
      dc.b $83, $54, $93, $52, $96, $07, $97, $50, $be, $03
      dc.b $c7, $23, $fe, $02, $0c, $82, $43, $45, $45, $24
      dc.b $46, $24, $90, $08, $95, $51, $78, $fa, $d7, $73
      dc.b $39, $f1, $8c, $01, $a8, $52, $b8, $52, $cc, $01
      dc.b $5f, $b3, $97, $63, $9e, $00, $0e, $81, $16, $24
      dc.b $66, $04, $8e, $00, $fe, $01, $08, $d2, $0e, $06
      dc.b $6f, $47, $9e, $0f, $0e, $82, $2d, $47, $28, $7a
      dc.b $68, $7a, $a8, $7a, $ae, $01, $de, $0f, $6d, $c5
      dc.b $fd

;level 4-2
L_UndergroundArea2:
      dc.b $48, $0f
      dc.b $0e, $01, $5e, $02, $bc, $01, $fc, $01, $2c, $82
      dc.b $41, $52, $4e, $04, $67, $25, $68, $24, $69, $24
      dc.b $ba, $42, $c7, $04, $de, $0b, $b2, $87, $fe, $02
      dc.b $2c, $e1, $2c, $71, $67, $01, $77, $00, $87, $01
      dc.b $8e, $00, $ee, $01, $f6, $02, $03, $85, $05, $02
      dc.b $13, $21, $16, $02, $27, $02, $2e, $02, $88, $72
      dc.b $c7, $20, $d7, $07, $e4, $76, $07, $a0, $17, $06
      dc.b $48, $7a, $76, $20, $98, $72, $79, $e1, $88, $62
      dc.b $9c, $01, $b7, $73, $dc, $01, $f8, $62, $fe, $01
      dc.b $08, $e2, $0e, $00, $6e, $02, $73, $20, $77, $23
      dc.b $83, $04, $93, $20, $ae, $00, $fe, $0a, $0e, $82
      dc.b $39, $71, $a8, $72, $e7, $73, $0c, $81, $8f, $32
      dc.b $ae, $00, $fe, $04, $04, $d1, $17, $04, $26, $49
      dc.b $27, $29, $df, $33, $fe, $02, $44, $f6, $7c, $01
      dc.b $8e, $06, $bf, $47, $ee, $0f, $4d, $c7, $0e, $82
      dc.b $68, $7a, $ae, $01, $de, $0f, $6d, $c5
      dc.b $fd

;underground bonus rooms area used in many levels
L_UndergroundArea3:
      dc.b $48, $01
      dc.b $0e, $01, $00, $5a, $3e, $06, $45, $46, $47, $46
      dc.b $53, $44, $ae, $01, $df, $4a, $4d, $c7, $0e, $81
      dc.b $00, $5a, $2e, $04, $37, $28, $3a, $48, $46, $47
      dc.b $c7, $07, $ce, $0f, $df, $4a, $4d, $c7, $0e, $81
      dc.b $00, $5a, $33, $53, $43, $51, $46, $40, $47, $50
      dc.b $53, $04, $55, $40, $56, $50, $62, $43, $64, $40
      dc.b $65, $50, $71, $41, $73, $51, $83, $51, $94, $40
      dc.b $95, $50, $a3, $50, $a5, $40, $a6, $50, $b3, $51
      dc.b $b6, $40, $b7, $50, $c3, $53, $df, $4a, $4d, $c7
      dc.b $0e, $81, $00, $5a, $2e, $02, $36, $47, $37, $52
      dc.b $3a, $49, $47, $25, $a7, $52, $d7, $04, $df, $4a
      dc.b $4d, $c7, $0e, $81, $00, $5a, $3e, $02, $44, $51
      dc.b $53, $44, $54, $44, $55, $24, $a1, $54, $ae, $01
      dc.b $b4, $21, $df, $4a, $e5, $07, $4d, $c7
      dc.b $fd

;water area used in levels 5-2 and 6-2
L_WaterArea1:
      dc.b $41, $01
      dc.b $b4, $34, $c8, $52, $f2, $51, $47, $d3, $6c, $03
      dc.b $65, $49, $9e, $07, $be, $01, $cc, $03, $fe, $07
      dc.b $0d, $c9, $1e, $01, $6c, $01, $62, $35, $63, $53
      dc.b $8a, $41, $ac, $01, $b3, $53, $e9, $51, $26, $c3
      dc.b $27, $33, $63, $43, $64, $33, $ba, $60, $c9, $61
      dc.b $ce, $0b, $e5, $09, $ee, $0f, $7d, $ca, $7d, $47
      dc.b $fd

;level 2-2/7-2
L_WaterArea2:
      dc.b $41, $01
      dc.b $b8, $52, $ea, $41, $27, $b2, $b3, $42, $16, $d4
      dc.b $4a, $42, $a5, $51, $a7, $31, $27, $d3, $08, $e2
      dc.b $16, $64, $2c, $04, $38, $42, $76, $64, $88, $62
      dc.b $de, $07, $fe, $01, $0d, $c9, $23, $32, $31, $51
      dc.b $98, $52, $0d, $c9, $59, $42, $63, $53, $67, $31
      dc.b $14, $c2, $36, $31, $87, $53, $17, $e3, $29, $61
      dc.b $30, $62, $3c, $08, $42, $37, $59, $40, $6a, $42
      dc.b $99, $40, $c9, $61, $d7, $63, $39, $d1, $58, $52
      dc.b $c3, $67, $d3, $31, $dc, $06, $f7, $42, $fa, $42
      dc.b $23, $b1, $43, $67, $c3, $34, $c7, $34, $d1, $51
      dc.b $43, $b3, $47, $33, $9a, $30, $a9, $61, $b8, $62
      dc.b $be, $0b, $d5, $09, $de, $0f, $0d, $ca, $7d, $47
      dc.b $fd

;water area used in level 8-4
L_WaterArea3:
      dc.b $49, $0f
      dc.b $1e, $01, $39, $73, $5e, $07, $ae, $0b, $1e, $82
      dc.b $6e, $88, $9e, $02, $0d, $04, $2e, $0b, $45, $09
      dc.b $4e, $0f, $ed, $47
      dc.b $fd
...
GameMode:
      ...
      dc.w InitializeArea
      dc.w ScreenRoutines
      dc.w SecondaryGameSetup
      dc.w GameCoreRoutine
...
GameRoutines:
      ...
      dc.w Entrance_GameTimerSetup
      dc.w Vine_AutoClimb
      dc.w SideExitPipeEntry
      dc.w VerticalPipeEntry
      dc.w FlagpoleSlide
      dc.w PlayerEndLevel
      dc.w PlayerLoseLife
      dc.w PlayerEntrance
      dc.w PlayerCtrlRoutine
      dc.w PlayerChangeSize
      dc.w PlayerInjuryBlink
      dc.w PlayerDeath
      dc.w PlayerFireFlower
...
JumpMForceData:
      dc.b $20, $20, $1e, $28, $28, $0d, $04

FallMForceData:
      dc.b $70, $70, $60, $90, $90, $0a, $09

PlayerYSpdData:
      dc.b $fc, $fc, $fc, $fb, $fb, $fe, $ff

InitMForceData:
      dc.b $00, $00, $00, $00, $00, $80, $00
...
BlockCode: jsr JumpEngine          ;run appropriate subroutine depending on block number
      ...
      dc.w MushFlowerBlock
      dc.w CoinBlock
      dc.w CoinBlock
      dc.w ExtraLifeMushBlock
      dc.w MushFlowerBlock
      dc.w VineBlock
      dc.w StarBlock
      dc.w CoinBlock
...
BrickQBlockMetatiles:
      dc.b $c1, $c0, $5f, $60 ;used by question blocks

      ;these two sets are functionally identical, but look different
      dc.b $55, $56, $57, $58, $59 ;used by ground level types
      dc.b $5a, $5b, $5c, $5d, $5e ;used by other level types
...
ResidualGravityCode:
      ...
      dc.b $2c        ;no code branches or jumps to it...
...
MovePlatformDown:
      ...
      dc.b $2c     ;part as BIT instruction)
...
;loop command data
LoopCmdWorldNumber:
      dc.b $03, $03, $06, $06, $06, $06, $06, $06, $07, $07, $07

LoopCmdPageNumber:
      dc.b $05, $09, $04, $05, $06, $08, $09, $0a, $06, $0b, $10

LoopCmdYPosition:
      dc.b $40, $b0, $b0, $80, $40, $40, $80, $40, $f0, $f0, $f0
...
;jump engine table for newly loaded enemy objects
      ...
      dc.w InitNormalEnemy  ;for objects $00-$0f
      dc.w InitNormalEnemy
      dc.w InitNormalEnemy
      dc.w InitRedKoopa
      dc.w NoInitCode
      dc.w InitHammerBro
      ...
      dc.w InitCheepCheep
      dc.w InitPodoboo
      dc.w InitPiranhaPlant
      dc.w InitJumpGPTroopa
      dc.w InitRedPTroopa

      dc.w InitHorizFlySwimEnemy  ;for objects $10-$1f
      dc.w InitLakitu
      dc.w InitEnemyFrenzy
      dc.w NoInitCode
      dc.w InitEnemyFrenzy
      dc.w InitEnemyFrenzy
      dc.w InitEnemyFrenzy
      ...
      dc.w NoInitCode
      dc.w NoInitCode
      dc.w InitShortFirebar
      dc.w InitShortFirebar
      dc.w InitShortFirebar
      dc.w InitShortFirebar
      dc.w InitLongFirebar

      dc.w NoInitCode ;for objects $20-$2f
      dc.w NoInitCode
      dc.w NoInitCode
      dc.w NoInitCode
      dc.w InitBalPlatform
      dc.w InitVertPlatform
      dc.w LargeLiftUp
      dc.w LargeLiftDown
      dc.w InitHoriPlatform
      dc.w InitDropPlatform
      dc.w InitHoriPlatform
      dc.w PlatLiftUp
      dc.w PlatLiftDown
      dc.w InitBowser
      dc.w PwrUpJmp   ;possibly dummy value
      dc.w Setup_Vine

      dc.w NoInitCode ;for objects $30-$36
      dc.w NoInitCode
      dc.w NoInitCode
      dc.w NoInitCode
      dc.w NoInitCode
      dc.w InitRetainerObj
      dc.w EndOfEnemyInitCode
...
FireworksXPosData:
      dc.b $00, $30, $60, $60, $00, $20

FireworksYPosData:
      dc.b $60, $40, $70, $40, $60, $30
...
;frenzy object jump table
      dc.w LakituAndSpinyHandler
      dc.w NoFrenzyCode
      dc.w InitFlyingCheepCheep
      dc.w InitBowserFlame
      dc.w InitFireworks
      dc.w BulletBillCheepCheep
...
JmpEO: jsr JumpEngine
      ...
      dc.w RunNormalEnemies  ;for objects $00-$14

      dc.w RunBowserFlame    ;for objects $15-$1f
      dc.w RunFireworks
      dc.w NoRunCode
      dc.w NoRunCode
      dc.w NoRunCode
      ...
      dc.w RunFirebarObj     ;for objects $20-$2f
      dc.w RunFirebarObj
      dc.w RunFirebarObj
      dc.w NoRunCode
      dc.w RunLargePlatform
      dc.w RunLargePlatform
      dc.w RunLargePlatform
      dc.w RunLargePlatform
      dc.w RunLargePlatform
      dc.w RunLargePlatform
      dc.w RunLargePlatform
      dc.w RunSmallPlatform
      dc.w RunSmallPlatform
      dc.w RunBowser
      dc.w PowerUpObjHandler
      dc.w VineObjectHandler

      dc.w NoRunCode         ;for objects $30-$35
      dc.w RunStarFlagObj
      dc.w JumpspringHandler
      dc.w NoRunCode
      dc.w WarpZoneObject
      dc.w RunRetainerObj
...
EnemyMovementSubs:
      ...
      dc.w MoveNormalEnemy      ;only objects $00-$14 use this table
      dc.w MoveNormalEnemy
      dc.w MoveNormalEnemy
      dc.w MoveNormalEnemy
      dc.w MoveNormalEnemy
      dc.w ProcHammerBro
      ...
      dc.w MoveBulletBill
      dc.w NoMoveCode
      dc.w MoveSwimmingCheepCheep
      dc.w MoveSwimmingCheepCheep
      dc.w MovePodoboo
      dc.w MovePiranhaPlant
      dc.w MoveJumpingEnemy
      dc.w ProcMoveRedPTroopa
      dc.w MoveFlyGreenPTroopa
      dc.w MoveLakitu
      dc.w MoveNormalEnemy
      dc.w NoMoveCode   ;dummy
      dc.w MoveFlyingCheepCheep
...
LargePlatformSubroutines:
      ...
      dc.w BalancePlatform   ;table used by objects $24-$2a
      dc.w YMovingPlatform
      dc.w MoveLargeLiftPlat
      dc.w MoveLargeLiftPlat
      dc.w XMovingPlatform
      dc.w DropPlatform
      dc.w RightPlatform
...
SwimCCXMoveData:
      dc.b $40, $80
      dc.b $04, $04 ;residual data, not used
...
FirebarPosLookupTbl:
      dc.b $00, $01, $03, $04, $05, $06, $07, $07, $08
      dc.b $00, $03, $06, $09, $0b, $0d, $0e, $0f, $10
      dc.b $00, $04, $09, $0d, $10, $13, $16, $17, $18
      dc.b $00, $06, $0c, $12, $16, $1a, $1d, $1f, $20
      dc.b $00, $07, $0f, $16, $1c, $21, $25, $27, $28
      dc.b $00, $09, $12, $1b, $21, $27, $2c, $2f, $30
      dc.b $00, $0b, $15, $1f, $27, $2e, $33, $37, $38
      dc.b $00, $0c, $18, $24, $2d, $35, $3b, $3e, $40
      dc.b $00, $0e, $1b, $28, $32, $3b, $42, $46, $48
      dc.b $00, $0f, $1f, $2d, $38, $42, $4a, $4e, $50
      dc.b $00, $11, $22, $31, $3e, $49, $51, $56, $58

FirebarMirrorData:
      dc.b $01, $03, $02, $00

FirebarTblOffsets:
      dc.b $00, $09, $12, $1b, $24, $2d
      dc.b $36, $3f, $48, $51, $5a, $63
...
BridgeCollapseData:
      dc.b $1a ;axe
      dc.b $58 ;chain
      dc.b $98, $96, $94, $92, $90, $8e, $8c ;bridge
      dc.b $8a, $88, $86, $84, $82, $80
...
RunStarFlagObj:
      ...
      dc.w StarFlagExit
      dc.w GameTimerFireworks
      dc.w AwardGameTimerPoints
      dc.w RaiseFlagSetoffFWorks
      dc.w DelayToAreaEnd
...
BowserIdentities:
      dc.b Goomba, GreenKoopa, BuzzyBeetle, Spiny, Lakitu, Bloober, HammerBro, Bowser
...
SetBitsMask:
      dc.b %10000000, %01000000, %00100000, %00010000, %00001000, %00000100, %00000010
...
BlockBuffer_X_Adder:
      dc.b $08, $03, $0c, $02, $02, $0d, $0d, $08
      dc.b $03, $0c, $02, $02, $0d, $0d, $08, $03
      dc.b $0c, $02, $02, $0d, $0d, $08, $00, $10
      dc.b $04, $14, $04, $04

BlockBuffer_Y_Adder:
      dc.b $04, $20, $20, $08, $18, $08, $18, $02
      dc.b $20, $20, $08, $18, $08, $18, $12, $20
      dc.b $20, $18, $18, $18, $18, $18, $14, $14
      dc.b $06, $06, $08, $10
...
PowerUpGfxTable:
      dc.b $76, $77, $78, $79 ;regular mushroom
      dc.b $d6, $d6, $d9, $d9 ;fire flower
      dc.b $8d, $8d, $e4, $e4 ;star
      dc.b $76, $77, $78, $79 ;1-up mushroom
...
EnemyGraphicsTable:
      dc.b $fc, $fc, $aa, $ab, $ac, $ad  ;buzzy beetle frame 1
      dc.b $fc, $fc, $ae, $af, $b0, $b1  ;             frame 2
      dc.b $fc, $a5, $a6, $a7, $a8, $a9  ;koopa troopa frame 1
      dc.b $fc, $a0, $a1, $a2, $a3, $a4  ;             frame 2
      dc.b $69, $a5, $6a, $a7, $a8, $a9  ;koopa paratroopa frame 1
      dc.b $6b, $a0, $6c, $a2, $a3, $a4  ;                 frame 2
      dc.b $fc, $fc, $96, $97, $98, $99  ;spiny frame 1
      dc.b $fc, $fc, $9a, $9b, $9c, $9d  ;      frame 2
      dc.b $fc, $fc, $8f, $8e, $8e, $8f  ;spiny's egg frame 1
      dc.b $fc, $fc, $95, $94, $94, $95  ;            frame 2
      dc.b $fc, $fc, $dc, $dc, $df, $df  ;bloober frame 1
      dc.b $dc, $dc, $dd, $dd, $de, $de  ;        frame 2
      dc.b $fc, $fc, $b2, $b3, $b4, $b5  ;cheep-cheep frame 1
      dc.b $fc, $fc, $b6, $b3, $b7, $b5  ;            frame 2
      dc.b $fc, $fc, $70, $71, $72, $73  ;goomba
      dc.b $fc, $fc, $6e, $6e, $6f, $6f  ;koopa shell frame 1 (upside-down)
      dc.b $fc, $fc, $6d, $6d, $6f, $6f  ;            frame 2
      dc.b $fc, $fc, $6f, $6f, $6e, $6e  ;koopa shell frame 1 (rightsideup)
      dc.b $fc, $fc, $6f, $6f, $6d, $6d  ;            frame 2
      dc.b $fc, $fc, $f4, $f4, $f5, $f5  ;buzzy beetle shell frame 1 (rightsideup)
      dc.b $fc, $fc, $f4, $f4, $f5, $f5  ;                   frame 2
      dc.b $fc, $fc, $f5, $f5, $f4, $f4  ;buzzy beetle shell frame 1 (upside-down)
      dc.b $fc, $fc, $f5, $f5, $f4, $f4  ;                   frame 2
      dc.b $fc, $fc, $fc, $fc, $ef, $ef  ;defeated goomba
      dc.b $b9, $b8, $bb, $ba, $bc, $bc  ;lakitu frame 1
      dc.b $fc, $fc, $bd, $bd, $bc, $bc  ;       frame 2
      dc.b $7a, $7b, $da, $db, $d8, $d8  ;princess
      dc.b $cd, $cd, $ce, $ce, $cf, $cf  ;mushroom retainer
      dc.b $7d, $7c, $d1, $8c, $d3, $d2  ;hammer bro frame 1
      dc.b $7d, $7c, $89, $88, $8b, $8a  ;           frame 2
      dc.b $d5, $d4, $e3, $e2, $d3, $d2  ;           frame 3
      dc.b $d5, $d4, $e3, $e2, $8b, $8a  ;           frame 4
      dc.b $e5, $e5, $e6, $e6, $eb, $eb  ;piranha plant frame 1
      dc.b $ec, $ec, $ed, $ed, $ee, $ee  ;              frame 2
      dc.b $fc, $fc, $d0, $d0, $d7, $d7  ;podoboo
      dc.b $bf, $be, $c1, $c0, $c2, $fc  ;bowser front frame 1
      dc.b $c4, $c3, $c6, $c5, $c8, $c7  ;bowser rear frame 1
      dc.b $bf, $be, $ca, $c9, $c2, $fc  ;       front frame 2
      dc.b $c4, $c3, $c6, $c5, $cc, $cb  ;       rear frame 2
      dc.b $fc, $fc, $e8, $e7, $ea, $e9  ;bullet bill
      dc.b $f2, $f2, $f3, $f3, $f2, $f2  ;jumpspring frame 1
      dc.b $f1, $f1, $f1, $f1, $fc, $fc  ;           frame 2
      dc.b $f0, $f0, $fc, $fc, $fc, $fc  ;           frame 3

EnemyGfxTableOffsets:
      dc.b $0c, $0c, $00, $0c, $0c, $a8, $54, $3c
      dc.b $ea, $18, $48, $48, $cc, $c0, $18, $18
      dc.b $18, $90, $24, $ff, $48, $9c, $d2, $d8
      dc.b $f0, $f6, $fc

EnemyAttributeData:
      dc.b $01, $02, $03, $02, $01, $01, $03, $03
      dc.b $03, $01, $01, $02, $02, $21, $01, $02
      dc.b $01, $01, $02, $ff, $02, $02, $01, $01
      dc.b $02, $02, $02
...
DefaultBlockObjTiles:
      dc.b $85, $85, $86, $86             ;brick w/ line (these are sprite tiles, not BG!)
...
PlayerGfxTblOffsets:
      dc.b $20, $28, $c8, $18, $00, $40, $50, $58
      dc.b $80, $88, $b8, $78, $60, $a0, $b0, $b8

;tiles arranged in order, 2 tiles per row, top to bottom

PlayerGraphicsTable:
;big player table
      dc.b $00, $01, $02, $03, $04, $05, $06, $07 ;walking frame 1
      dc.b $08, $09, $0a, $0b, $0c, $0d, $0e, $0f ;        frame 2
      dc.b $10, $11, $12, $13, $14, $15, $16, $17 ;        frame 3
      dc.b $18, $19, $1a, $1b, $1c, $1d, $1e, $1f ;skidding
      dc.b $20, $21, $22, $23, $24, $25, $26, $27 ;jumping
      dc.b $08, $09, $28, $29, $2a, $2b, $2c, $2d ;swimming frame 1
      dc.b $08, $09, $0a, $0b, $0c, $30, $2c, $2d ;         frame 2
      dc.b $08, $09, $0a, $0b, $2e, $2f, $2c, $2d ;         frame 3
      dc.b $08, $09, $28, $29, $2a, $2b, $5c, $5d ;climbing frame 1
      dc.b $08, $09, $0a, $0b, $0c, $0d, $5e, $5f ;         frame 2
      dc.b $fc, $fc, $08, $09, $58, $59, $5a, $5a ;crouching
      dc.b $08, $09, $28, $29, $2a, $2b, $0e, $0f ;fireball throwing

;small player table
      dc.b $fc, $fc, $fc, $fc, $32, $33, $34, $35 ;walking frame 1
      dc.b $fc, $fc, $fc, $fc, $36, $37, $38, $39 ;        frame 2
      dc.b $fc, $fc, $fc, $fc, $3a, $37, $3b, $3c ;        frame 3
      dc.b $fc, $fc, $fc, $fc, $3d, $3e, $3f, $40 ;skidding
      dc.b $fc, $fc, $fc, $fc, $32, $41, $42, $43 ;jumping
      dc.b $fc, $fc, $fc, $fc, $32, $33, $44, $45 ;swimming frame 1
      dc.b $fc, $fc, $fc, $fc, $32, $33, $44, $47 ;         frame 2
      dc.b $fc, $fc, $fc, $fc, $32, $33, $48, $49 ;         frame 3
      dc.b $fc, $fc, $fc, $fc, $32, $33, $90, $91 ;climbing frame 1
      dc.b $fc, $fc, $fc, $fc, $3a, $37, $92, $93 ;         frame 2
      dc.b $fc, $fc, $fc, $fc, $9e, $9e, $9f, $9f ;killed

;used by both player sizes
      dc.b $fc, $fc, $fc, $fc, $3a, $37, $4f, $4f ;small player standing
      dc.b $fc, $fc, $00, $01, $4c, $4d, $4e, $4e ;intermediate grow frame
      dc.b $00, $01, $4c, $4d, $4a, $4a, $4b, $4b ;big player standing
...
ChangeSizeOffsetAdder:
        dc.b $00, $01, $00, $01, $00, $01, $02, $00, $01, $02
        dc.b $02, $00, $02, $00, $02, $00, $02, $00, $02, $00
...
SwimStompEnvelopeData:
      dc.b $9f, $9b, $98, $96, $95, $94, $92, $90
      dc.b $90, $9a, $97, $95, $93, $92
...
ExtraLifeFreqData:
      dc.b $58, $02, $54, $56, $4e, $44

PowerUpGrabFreqData:
      dc.b $4c, $52, $4c, $48, $3e, $36, $3e, $36, $30
      dc.b $28, $4a, $50, $4a, $64, $3c, $32, $3c, $32
      dc.b $2c, $24, $3a, $64, $3a, $34, $2c, $22, $2c

;residual frequency data
      dc.b $22, $1c, $14

PUp_VGrow_FreqData:
      dc.b $14, $04, $22, $24, $16, $04, $24, $26 ;used by both
      dc.b $18, $04, $26, $28, $1a, $04, $28, $2a
      dc.b $1c, $04, $2a, $2c, $1e, $04, $2c, $2e ;used by vinegrow
      dc.b $20, $04, $2e, $30, $22, $04, $30, $32
...
BrickShatterFreqData:
        dc.b $01, $0e, $0e, $0d, $0b, $06, $0c, $0f
        dc.b $0a, $09, $03, $0d, $08, $0d, $06, $0c
...
MusicHeaderData:
      dc.b DeathMusHdr-MHD           ;event music
      dc.b GameOverMusHdr-MHD
      dc.b VictoryMusHdr-MHD
      dc.b WinCastleMusHdr-MHD
      dc.b GameOverMusHdr-MHD
      dc.b EndOfLevelMusHdr-MHD
      dc.b TimeRunningOutHdr-MHD
      dc.b SilenceHdr-MHD

      dc.b GroundLevelPart1Hdr-MHD   ;area music
      dc.b WaterMusHdr-MHD
      dc.b UndergroundMusHdr-MHD
      dc.b CastleMusHdr-MHD
      dc.b Star_CloudHdr-MHD
      dc.b GroundLevelLeadInHdr-MHD
      dc.b Star_CloudHdr-MHD
      dc.b SilenceHdr-MHD

      dc.b GroundLevelLeadInHdr-MHD  ;ground level music layout
      dc.b GroundLevelPart1Hdr-MHD, GroundLevelPart1Hdr-MHD
      dc.b GroundLevelPart2AHdr-MHD, GroundLevelPart2BHdr-MHD, GroundLevelPart2AHdr-MHD, GroundLevelPart2CHdr-MHD
      dc.b GroundLevelPart2AHdr-MHD, GroundLevelPart2BHdr-MHD, GroundLevelPart2AHdr-MHD, GroundLevelPart2CHdr-MHD
      dc.b GroundLevelPart3AHdr-MHD, GroundLevelPart3BHdr-MHD, GroundLevelPart3AHdr-MHD, GroundLevelLeadInHdr-MHD
      dc.b GroundLevelPart1Hdr-MHD, GroundLevelPart1Hdr-MHD
      dc.b GroundLevelPart4AHdr-MHD, GroundLevelPart4BHdr-MHD, GroundLevelPart4AHdr-MHD, GroundLevelPart4CHdr-MHD
      dc.b GroundLevelPart4AHdr-MHD, GroundLevelPart4BHdr-MHD, GroundLevelPart4AHdr-MHD, GroundLevelPart4CHdr-MHD
      dc.b GroundLevelPart3AHdr-MHD, GroundLevelPart3BHdr-MHD, GroundLevelPart3AHdr-MHD, GroundLevelLeadInHdr-MHD
      dc.b GroundLevelPart4AHdr-MHD, GroundLevelPart4BHdr-MHD, GroundLevelPart4AHdr-MHD, GroundLevelPart4CHdr-MHD
...
TimeRunningOutHdr:    dc.b $08, <TimeRunOutMusData, >TimeRunOutMusData, $27, $18
Star_CloudHdr:        dc.b $20, <Star_CloudMData, >Star_CloudMData, $2e, $1a, $40
EndOfLevelMusHdr:     dc.b $20, <WinLevelMusData, >WinLevelMusData, $3d, $21
ResidualHeaderData:   dc.b $20, $c4, $fc, $3f, $1d
UndergroundMusHdr:    dc.b $18, <UndergroundMusData, >UndergroundMusData, $00, $00
SilenceHdr:           dc.b $08, <SilenceData, >SilenceData, $00
CastleMusHdr:         dc.b $00, <CastleMusData, >CastleMusData, $93, $62
VictoryMusHdr:        dc.b $10, <VictoryMusData, >VictoryMusData, $24, $14
GameOverMusHdr:       dc.b $18, <GameOverMusData, >GameOverMusData, $1e, $14
WaterMusHdr:          dc.b $08, <WaterMusData, >WaterMusData, $a0, $70, $68
WinCastleMusHdr:      dc.b $08, <EndOfCastleMusData, >EndOfCastleMusData, $4c, $24
GroundLevelPart1Hdr:  dc.b $18, <GroundM_P1Data, >GroundM_P1Data, $2d, $1c, $b8
GroundLevelPart2AHdr: dc.b $18, <GroundM_P2AData, >GroundM_P2AData, $20, $12, $70
GroundLevelPart2BHdr: dc.b $18, <GroundM_P2BData, >GroundM_P2BData, $1b, $10, $44
GroundLevelPart2CHdr: dc.b $18, <GroundM_P2CData, >GroundM_P2CData, $11, $0a, $1c
GroundLevelPart3AHdr: dc.b $18, <GroundM_P3AData, >GroundM_P3AData, $2d, $10, $58
GroundLevelPart3BHdr: dc.b $18, <GroundM_P3BData, >GroundM_P3BData, $14, $0d, $3f
GroundLevelLeadInHdr: dc.b $18, <GroundMLdInData, >GroundMLdInData, $15, $0d, $21
GroundLevelPart4AHdr: dc.b $18, <GroundM_P4AData, >GroundM_P4AData, $18, $10, $7a
GroundLevelPart4BHdr: dc.b $18, <GroundM_P4BData, >GroundM_P4BData, $19, $0f, $54
GroundLevelPart4CHdr: dc.b $18, <GroundM_P4CData, >GroundM_P4CData, $1e, $12, $2b
DeathMusHdr:          dc.b $18, <DeathMusData, >DeathMusData, $1e, $0f, $2d
...
Star_CloudMData:
      dc.b $84, $2c, $2c, $2c, $82, $04, $2c, $04, $85, $2c, $84, $2c, $2c
      dc.b $2a, $2a, $2a, $82, $04, $2a, $04, $85, $2a, $84, $2a, $2a, $00

      dc.b $1f, $1f, $1f, $98, $1f, $1f, $98, $9e, $98, $1f
      dc.b $1d, $1d, $1d, $94, $1d, $1d, $94, $9c, $94, $1d

      dc.b $86, $18, $85, $26, $30, $84, $04, $26, $30
      dc.b $86, $14, $85, $22, $2c, $84, $04, $22, $2c

      dc.b $21, $d0, $c4, $d0, $31, $d0, $c4, $d0, $00

GroundM_P1Data:
      dc.b $85, $2c, $22, $1c, $84, $26, $2a, $82, $28, $26, $04
      dc.b $87, $22, $34, $3a, $82, $40, $04, $36, $84, $3a, $34
      dc.b $82, $2c, $30, $85, $2a

SilenceData:
      dc.b $00

      dc.b $5d, $55, $4d, $15, $19, $96, $15, $d5, $e3, $eb
      dc.b $2d, $a6, $2b, $27, $9c, $9e, $59

      dc.b $85, $22, $1c, $14, $84, $1e, $22, $82, $20, $1e, $04, $87
      dc.b $1c, $2c, $34, $82, $36, $04, $30, $34, $04, $2c, $04, $26
      dc.b $2a, $85, $22

GroundM_P2AData:
      dc.b $84, $04, $82, $3a, $38, $36, $32, $04, $34
      dc.b $04, $24, $26, $2c, $04, $26, $2c, $30, $00

      dc.b $05, $b4, $b2, $b0, $2b, $ac, $84
      dc.b $9c, $9e, $a2, $84, $94, $9c, $9e

      dc.b $85, $14, $22, $84, $2c, $85, $1e
      dc.b $82, $2c, $84, $2c, $1e

GroundM_P2BData:
      dc.b $84, $04, $82, $3a, $38, $36, $32, $04, $34
      dc.b $04, $64, $04, $64, $86, $64, $00

      dc.b $05, $b4, $b2, $b0, $2b, $ac, $84
      dc.b $37, $b6, $b6, $45

      dc.b $85, $14, $1c, $82, $22, $84, $2c
      dc.b $4e, $82, $4e, $84, $4e, $22

GroundM_P2CData:
      dc.b $84, $04, $85, $32, $85, $30, $86, $2c, $04, $00

      dc.b $05, $a4, $05, $9e, $05, $9d, $85
      
      dc.b $84, $14, $85, $24, $28, $2c, $82
      dc.b $22, $84, $22, $14

      dc.b $21, $d0, $c4, $d0, $31, $d0, $c4, $d0, $00

GroundM_P3AData:
      dc.b $82, $2c, $84, $2c, $2c, $82, $2c, $30
      dc.b $04, $34, $2c, $04, $26, $86, $22, $00

      dc.b $a4, $25, $25, $a4, $29, $a2, $1d, $9c, $95

GroundM_P3BData:
      dc.b $82, $2c, $2c, $04, $2c, $04, $2c, $30, $85, $34, $04, $04, $00

      dc.b $a4, $25, $25, $a4, $a8, $63, $04

;triangle data used by both sections of third part
      dc.b $85, $0e, $1a, $84, $24, $85, $22, $14, $84, $0c

GroundMLdInData:
      dc.b $82, $34, $84, $34, $34, $82, $2c, $84, $34, $86, $3a, $04, $00

      dc.b $a0, $21, $21, $a0, $21, $2b, $05, $a3

      dc.b $82, $18, $84, $18, $18, $82, $18, $18, $04, $86, $3a, $22

;noise data used by lead-in and third part sections
      dc.b $31, $90, $31, $90, $31, $71, $31, $90, $90, $90, $00

GroundM_P4AData:
      dc.b $82, $34, $84, $2c, $85, $22, $84, $24
      dc.b $82, $26, $36, $04, $36, $86, $26, $00

      dc.b $ac, $27, $5d, $1d, $9e, $2d, $ac, $9f

      dc.b $85, $14, $82, $20, $84, $22, $2c
      dc.b $1e, $1e, $82, $2c, $2c, $1e, $04

GroundM_P4BData:
      dc.b $87, $2a, $40, $40, $40, $3a, $36 
      dc.b $82, $34, $2c, $04, $26, $86, $22, $00

      dc.b $e3, $f7, $f7, $f7, $f5, $f1, $ac, $27, $9e, $9d

      dc.b $85, $18, $82, $1e, $84, $22, $2a
      dc.b $22, $22, $82, $2c, $2c, $22, $04

DeathMusData:
      dc.b $86, $04 ;death music share data with fourth part c of ground level music 

GroundM_P4CData:
      dc.b $82, $2a, $36, $04, $36, $87, $36, $34, $30, $86, $2c, $04, $00
      
      dc.b $00, $68, $6a, $6c, $45 ;death music only

      dc.b $a2, $31, $b0, $f1, $ed, $eb, $a2, $1d, $9c, $95

      dc.b $86, $04 ;death music only

      dc.b $85, $22, $82, $22, $87, $22, $26, $2a, $84, $2c, $22, $86, $14

;noise data used by fourth part sections
      dc.b $51, $90, $31, $11, $00

CastleMusData:
      dc.b $80, $22, $28, $22, $26, $22, $24, $22, $26
      dc.b $22, $28, $22, $2a, $22, $28, $22, $26
      dc.b $22, $28, $22, $26, $22, $24, $22, $26
      dc.b $22, $28, $22, $2a, $22, $28, $22, $26
      dc.b $20, $26, $20, $24, $20, $26, $20, $28
      dc.b $20, $26, $20, $28, $20, $26, $20, $24
      dc.b $20, $26, $20, $24, $20, $26, $20, $28
      dc.b $20, $26, $20, $28, $20, $26, $20, $24
      dc.b $28, $30, $28, $32, $28, $30, $28, $2e
      dc.b $28, $30, $28, $2e, $28, $2c, $28, $2e
      dc.b $28, $30, $28, $32, $28, $30, $28, $2e
      dc.b $28, $30, $28, $2e, $28, $2c, $28, $2e, $00

      dc.b $04, $70, $6e, $6c, $6e, $70, $72, $70, $6e
      dc.b $70, $6e, $6c, $6e, $70, $72, $70, $6e
      dc.b $6e, $6c, $6e, $70, $6e, $70, $6e, $6c
      dc.b $6e, $6c, $6e, $70, $6e, $70, $6e, $6c
      dc.b $76, $78, $76, $74, $76, $74, $72, $74
      dc.b $76, $78, $76, $74, $76, $74, $72, $74

      dc.b $84, $1a, $83, $18, $20, $84, $1e, $83, $1c, $28
      dc.b $26, $1c, $1a, $1c

GameOverMusData:
      dc.b $82, $2c, $04, $04, $22, $04, $04, $84, $1c, $87
      dc.b $26, $2a, $26, $84, $24, $28, $24, $80, $22, $00

      dc.b $9c, $05, $94, $05, $0d, $9f, $1e, $9c, $98, $9d

      dc.b $82, $22, $04, $04, $1c, $04, $04, $84, $14
      dc.b $86, $1e, $80, $16, $80, $14

TimeRunOutMusData:
      dc.b $81, $1c, $30, $04, $30, $30, $04, $1e, $32, $04, $32, $32
      dc.b $04, $20, $34, $04, $34, $34, $04, $36, $04, $84, $36, $00

      dc.b $46, $a4, $64, $a4, $48, $a6, $66, $a6, $4a, $a8, $68, $a8
      dc.b $6a, $44, $2b

      dc.b $81, $2a, $42, $04, $42, $42, $04, $2c, $64, $04, $64, $64
      dc.b $04, $2e, $46, $04, $46, $46, $04, $22, $04, $84, $22

WinLevelMusData:
      dc.b $87, $04, $06, $0c, $14, $1c, $22, $86, $2c, $22
      dc.b $87, $04, $60, $0e, $14, $1a, $24, $86, $2c, $24
      dc.b $87, $04, $08, $10, $18, $1e, $28, $86, $30, $30
      dc.b $80, $64, $00

      dc.b $cd, $d5, $dd, $e3, $ed, $f5, $bb, $b5, $cf, $d5
      dc.b $db, $e5, $ed, $f3, $bd, $b3, $d1, $d9, $df, $e9
      dc.b $f1, $f7, $bf, $ff, $ff, $ff, $34
      dc.b $00 ;unused byte

      dc.b $86, $04, $87, $14, $1c, $22, $86, $34, $84, $2c
      dc.b $04, $04, $04, $87, $14, $1a, $24, $86, $32, $84
      dc.b $2c, $04, $86, $04, $87, $18, $1e, $28, $86, $36
      dc.b $87, $30, $30, $30, $80, $2c

;square 2 and triangle use the same data, square 1 is unused
UndergroundMusData:
      dc.b $82, $14, $2c, $62, $26, $10, $28, $80, $04
      dc.b $82, $14, $2c, $62, $26, $10, $28, $80, $04
      dc.b $82, $08, $1e, $5e, $18, $60, $1a, $80, $04
      dc.b $82, $08, $1e, $5e, $18, $60, $1a, $86, $04
      dc.b $83, $1a, $18, $16, $84, $14, $1a, $18, $0e, $0c
      dc.b $16, $83, $14, $20, $1e, $1c, $28, $26, $87
      dc.b $24, $1a, $12, $10, $62, $0e, $80, $04, $04
      dc.b $00

;noise data directly follows square 2 here unlike in other songs
WaterMusData:
      dc.b $82, $18, $1c, $20, $22, $26, $28 
      dc.b $81, $2a, $2a, $2a, $04, $2a, $04, $83, $2a, $82, $22
      dc.b $86, $34, $32, $34, $81, $04, $22, $26, $2a, $2c, $30
      dc.b $86, $34, $83, $32, $82, $36, $84, $34, $85, $04, $81, $22
      dc.b $86, $30, $2e, $30, $81, $04, $22, $26, $2a, $2c, $2e
      dc.b $86, $30, $83, $22, $82, $36, $84, $34, $85, $04, $81, $22
      dc.b $86, $3a, $3a, $3a, $82, $3a, $81, $40, $82, $04, $81, $3a
      dc.b $86, $36, $36, $36, $82, $36, $81, $3a, $82, $04, $81, $36
      dc.b $86, $34, $82, $26, $2a, $36
      dc.b $81, $34, $34, $85, $34, $81, $2a, $86, $2c, $00

      dc.b $84, $90, $b0, $84, $50, $50, $b0, $00

      dc.b $98, $96, $94, $92, $94, $96, $58, $58, $58, $44
      dc.b $5c, $44, $9f, $a3, $a1, $a3, $85, $a3, $e0, $a6
      dc.b $23, $c4, $9f, $9d, $9f, $85, $9f, $d2, $a6, $23
      dc.b $c4, $b5, $b1, $af, $85, $b1, $af, $ad, $85, $95
      dc.b $9e, $a2, $aa, $6a, $6a, $6b, $5e, $9d

      dc.b $84, $04, $04, $82, $22, $86, $22
      dc.b $82, $14, $22, $2c, $12, $22, $2a, $14, $22, $2c
      dc.b $1c, $22, $2c, $14, $22, $2c, $12, $22, $2a, $14
      dc.b $22, $2c, $1c, $22, $2c, $18, $22, $2a, $16, $20
      dc.b $28, $18, $22, $2a, $12, $22, $2a, $18, $22, $2a
      dc.b $12, $22, $2a, $14, $22, $2c, $0c, $22, $2c, $14, $22, $34, $12
      dc.b $22, $30, $10, $22, $2e, $16, $22, $34, $18, $26
      dc.b $36, $16, $26, $36, $14, $26, $36, $12, $22, $36
      dc.b $5c, $22, $34, $0c, $22, $22, $81, $1e, $1e, $85, $1e
      dc.b $81, $12, $86, $14

EndOfCastleMusData:
      dc.b $81, $2c, $22, $1c, $2c, $22, $1c, $85, $2c, $04
      dc.b $81, $2e, $24, $1e, $2e, $24, $1e, $85, $2e, $04
      dc.b $81, $32, $28, $22, $32, $28, $22, $85, $32
      dc.b $87, $36, $36, $36, $84, $3a, $00

      dc.b $5c, $54, $4c, $5c, $54, $4c
      dc.b $5c, $1c, $1c, $5c, $5c, $5c, $5c
      dc.b $5e, $56, $4e, $5e, $56, $4e
      dc.b $5e, $1e, $1e, $5e, $5e, $5e, $5e
      dc.b $62, $5a, $50, $62, $5a, $50
      dc.b $62, $22, $22, $62, $e7, $e7, $e7, $2b

      dc.b $86, $14, $81, $14, $80, $14, $14, $81, $14, $14, $14, $14
      dc.b $86, $16, $81, $16, $80, $16, $16, $81, $16, $16, $16, $16
      dc.b $81, $28, $22, $1a, $28, $22, $1a, $28, $80, $28, $28
      dc.b $81, $28, $87, $2c, $2c, $2c, $84, $30

VictoryMusData:
      dc.b $83, $04, $84, $0c, $83, $62, $10, $84, $12
      dc.b $83, $1c, $22, $1e, $22, $26, $18, $1e, $04, $1c, $00

      dc.b $e3, $e1, $e3, $1d, $de, $e0, $23
      dc.b $ec, $75, $74, $f0, $f4, $f6, $ea, $31, $2d

      dc.b $83, $12, $14, $04, $18, $1a, $1c, $14
      dc.b $26, $22, $1e, $1c, $18, $1e, $22, $0c, $14

;unused space
      dc.b $ff, $ff, $ff

FreqRegLookupTbl:
      dc.b $00, $88, $00, $2f, $00, $00
      dc.b $02, $a6, $02, $80, $02, $5c, $02, $3a
      dc.b $02, $1a, $01, $df, $01, $c4, $01, $ab
      dc.b $01, $93, $01, $7c, $01, $67, $01, $53
      dc.b $01, $40, $01, $2e, $01, $1d, $01, $0d
      dc.b $00, $fe, $00, $ef, $00, $e2, $00, $d5
      dc.b $00, $c9, $00, $be, $00, $b3, $00, $a9
      dc.b $00, $a0, $00, $97, $00, $8e, $00, $86
      dc.b $00, $77, $00, $7e, $00, $71, $00, $54
      dc.b $00, $64, $00, $5f, $00, $59, $00, $50
      dc.b $00, $47, $00, $43, $00, $3b, $00, $35
      dc.b $00, $2a, $00, $23, $04, $75, $03, $57
      dc.b $02, $f9, $02, $cf, $01, $fc, $00, $6a

MusicLengthLookupTbl:
      dc.b $05, $0a, $14, $28, $50, $1e, $3c, $02
      dc.b $04, $08, $10, $20, $40, $18, $30, $0c
      dc.b $03, $06, $0c, $18, $30, $12, $24, $08
      dc.b $36, $03, $09, $06, $12, $1b, $24, $0c
      dc.b $24, $02, $06, $04, $0c, $12, $18, $08
      dc.b $12, $01, $03, $02, $06, $09, $0c, $04

EndOfCastleMusicEnvData:
      dc.b $98, $99, $9a, $9b

AreaMusicEnvData:
      dc.b $90, $94, $94, $95, $95, $96, $97, $98

WaterEventMusEnvData:
      dc.b $90, $91, $92, $92, $93, $93, $93, $94
      dc.b $94, $94, $94, $94, $94, $95, $95, $95
      dc.b $95, $95, $95, $96, $96, $96, $96, $96
      dc.b $96, $96, $96, $96, $96, $96, $96, $96
      dc.b $96, $96, $96, $96, $95, $95, $94, $93

BowserFlameEnvData:
      dc.b $15, $16, $16, $17, $17, $18, $19, $19
      dc.b $1a, $1a, $1c, $1d, $1d, $1e, $1e, $1f
      dc.b $1f, $1f, $1f, $1e, $1d, $1c, $1e, $1f
      dc.b $1f, $1e, $1d, $1c, $1a, $18, $16, $14
